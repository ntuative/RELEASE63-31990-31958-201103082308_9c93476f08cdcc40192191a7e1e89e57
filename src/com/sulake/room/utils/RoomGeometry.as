package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1018:Number = 32;
      ...
      private var var_2792:Number = -500.0;
      
      private var var_2793:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1570 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_158.x,this.var_158.y,this.var_158.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_79.x * this.var_401,this.var_79.y * this.var_400,this.var_79.z * this.var_402);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_238.x,this.var_238.y,this.var_238.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_401 != param1 * this.var_1569)
         {
            this.var_401 = param1 * this.var_1569;
            ++this.var_142;
         }
      }
      ...
      {
         if(this.var_400 != param1 * this.var_1571)
         {
            this.var_400 = param1 * this.var_1571;
            ++this.var_142;
         }
      }
      ...
      {
         if(this.var_402 != param1 * this.var_1570)
         {
            this.var_402 = param1 * this.var_1570;
            ++this.var_142;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_79.x /= this.var_401;
         this.var_79.y /= this.var_400;
         this.var_79.z /= this.var_402;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_238.x;
         var _loc3_:Number = this.var_238.y;
         var _loc4_:Number = this.var_238.z;
         this.var_238.assign(param1);
         if(this.var_238.x != _loc2_ || this.var_238.y != _loc3_ || this.var_238.z != _loc4_)
         {
            ++this.var_142;
         }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_468 != null)
         {
            ...
            return this.var_468.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1030.assign(_loc22_);
         }
         else
         {
            this.var_1030.assign(_loc17_);
         }
         ++this.var_142;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1030);
         if(_loc3_ < this.var_2792 || _loc3_ > this.var_2793)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_400;
            _loc2_.z *= this.var_402;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1030);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_79.x * this.var_401,this.var_79.y * this.var_400,this.var_79.z * this.var_402);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_158;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_401,param2.y * this.var_400,param2.z * this.var_402);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_401,param3.y * this.var_400,param3.z * this.var_402);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_401,param4.y * this.var_400,param4.z * this.var_402);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1018;
         }
         else
         {
            this.scale = const_706;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_706;
      }
