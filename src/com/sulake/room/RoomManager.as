package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2841:IRoomContentLoader;
      
      private var var_608:IRoomObjectFactory = null;
      
      private var var_504:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1152:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_609 = [];
         this.var_553 = [];
         events.addEventListener(RoomContentLoadedEvent.const_386,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_466,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_739,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_608 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_608 == null || this.var_504 == null)
         {
            return;
         }
         this._state = const_1407;
         if(this.var_1152 != null)
         {
            _loc1_ = this.var_1152;
            this.var_1152 = null;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_504.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_504.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_608.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_608 != null)
         {
            return this.var_608.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_716)
         {
            return;
         }
         if(this.var_50 == null)
         {
            this._state = const_716;
            return;
         }
         if(this.var_50.getGraphicAssetCollection(param1) != null)
         {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_50 == null || this.var_504 == null)
         {
            return;
         }
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_504.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_504.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_608.createRoomObjectLogic(_loc18_);
