package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_1404:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2529:Number = -1.0E7;
      
      private var var_2528:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_259.addChild(this.var_59);
         ...
         this.var_260 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
      ...
      {
         this.var_502.x -= param1 - this.var_600;
         this.var_600 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_502.y -= param1 - this.var_598;
         this.var_598 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_923 = true;
            if(this.var_132 != null && !this.var_259.contains(this.var_132))
            {
               this.var_259.addChild(this.var_132);
               this.var_59.mask = this.var_132;
            }
         }
         else if(!param1 && this.var_923)
         {
            this.var_923 = false;
            if(this.var_132 != null && this.var_259.contains(this.var_132))
            {
               this.var_259.removeChild(this.var_132);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_597 != null)
         {
            ...
            {
               this.cleanSprite(this.var_597[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_597 = [];
         }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_743 != this.var_2530 || this._ht != this.var_2532)
         {
            _loc9_ = true;
         }
         if(this.var_59.x != this.var_600 || this.var_59.y != this.var_598)
         {
            this.var_59.x = this.var_600;
            this.var_59.y = this.var_598;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_503[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2530 = this.var_743;
         this.var_2532 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_600;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_598;
                  if(_loc19_ < this.var_743 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_600;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_597.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_744 || this.var_744 == 0)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_260.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_260.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1141 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1789;
         }
         this.var_1789 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1141;
         return this.var_1789;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_743 / 2;
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2529 || param2 != this.var_2528)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         while(_loc1_ < this.var_365.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1404.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
