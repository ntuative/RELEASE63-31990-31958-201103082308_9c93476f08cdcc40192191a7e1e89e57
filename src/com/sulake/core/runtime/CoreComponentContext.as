package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1289:String = "asset-libraries";
      
      private static const const_1295:String = "library";
      
      private static const const_1287:String = "service-libraries";
      
      private static const const_1290:String = "library";
      
      private static const const_1292:String = "component-libraries";
      
      private static const const_1294:String = "library";
      
      private static const const_1288:String = "error_data";
      ...
      private var var_363:LibraryLoaderQueue;
      
      private var var_736:IEventDispatcher;
      
      private var var_499:uint;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         {
            this.var_257.push(new Array());
            this.var_596.push(0);
            _loc3_++;
         }
         this._lastUpdateTimeMs = getTimer();
         attachComponent(this,[new IIDCore()]);
         var_453.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            ...
            case Core.const_756:
               ...
               var_453.addChild(new ProfilerViewer(this.var_199));
               break;
            case Core.const_568:
      ...
      {
         return this.var_499 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            var_453.removeEventListener(Event.ENTER_FRAME,this.onEnterFrame);
            var_453 = null;
            _loc3_ = 0;
            while(_loc3_ < CoreComponentContext.const_102)
            {
               _loc2_ = this.var_257[_loc3_] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1288,String(param4.getStackTrace()));
         }
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_736 = loadingEventDelegate;
         if(this.var_363 == null)
         {
            this.var_363 = new LibraryLoaderQueue(_debug);
         }
         try
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1550);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_736)
         {
            this.var_736.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_736)
         {
            ...
            this.var_736.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_736)
                  {
                     this.var_736.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_499 - this.var_363.length,this.var_499,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_199 ? 0 : this.var_1398 & 0;
         if(_loc3_ == Core.const_568)
         {
            this.var_257[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_257[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_199 ? 0 : this.var_1398 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_102)
         {
            _loc3_ = this.var_257[_loc5_] as Array;
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_596[priority] = 0;
            receivers = this.var_257[priority];
            index = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         var msCurrentTime:uint = param1;
         var msSinceLastUpdate:uint = param2;
         var maxTimePerFrame:uint = 1000 / var_453.stage.frameRate;
         priority = 0;
         while(priority < CoreComponentContext.const_102)
         {
            t = getTimer();
            ...
            {
               if(this.var_596[priority] < priority)
               {
                  ++this.var_596[priority];
                  skip = true;
               }
            }
            if(!skip)
