package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1072:String = "AssetLibraryReady";
      
      public static const const_748:String = "AssetLibraryLoaded";
      
      public static const const_1456:String = "AssetLibraryUnloaded";
      
      public static const const_1592:String = "AssetLibraryLoadError";
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_985 = new Dictionary(false);
      ...
      {
         if(this._file == param1.url && this.var_984)
         {
            if(!this.var_983 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_793,this.var_647);
            }
            this.var_983 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1072));
         }
         else
         {
      ...
      {
         var _loc2_:Class = this.var_985[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1026,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1006,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1077,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1098,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_27:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_443;
                     this.var_442.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_442.length ? this.getAssetByName(this.var_442[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_163)
         {
            ...
            {
               return this.var_442.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_163[param1] != null || (this.var_647 != null ? this.var_647[param1] != null : false);
      }
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_163)
            {
               if(this.var_163[_loc2_] == param1)
               {
                  this.var_442.splice(this.var_442.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(this.var_441[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_793 = _loc2_.manifest.copy();
         this.var_647 = _loc2_.resource;
         ...
         this.var_984 = true;
         dispatchEvent(new Event(AssetLibrary.const_748));
         dispatchEvent(new Event(AssetLibrary.const_1072));
         if(this.var_983)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1592));
         this.var_42 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_793.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_647[param1]);
