package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1674:uint = 1;
      
      protected static const const_1675:uint = 2;
      
      protected static const const_1676:uint = 4;
      
      protected static const const_1677:uint = 3;
      ...
      public static const const_1129:Boolean = false;
      ...
      protected var var_793:XML;
      
      protected var var_647:Class;
      ...
      protected var var_2853:uint = 0;
      
      protected var var_2776:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1129)
         {
            ...
            while(var_707.length < const_1450 && false)
            {
               _loc1_ = var_875.shift() as LibraryLoader;
      ...
      {
         return !!this.var_994 ? uint(this.var_1242 - this.var_2008) : uint(getTimer() - this.var_2008);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,this.var_384,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
            try
            {
               this.var_42.close();
            }
      ...
      public function resume() : void
      {
         ...
         {
            this.var_995 = false;
            if(!this.var_994 && this.var_232)
            {
               this.var_1242 = -1;
               this.var_2008 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_994 && !_disposed && this.var_1243 > 0)
         {
            try
            {
               this.var_42.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_232,const_1412 - this.var_1243);
            if(this.var_2776)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               this.var_384 = HTTPStatusEvent(param1).status;
               this.debug("Load event STATUS " + this.var_384 + " for file \"" + this.url + "\"");
               break;
            case Event.UNLOAD:
               this.debug("Load event UNLOAD for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,this.var_384,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case ProgressEvent.PROGRESS:
               this.debug("Load event PROGRESS for file \"" + this.url + "\"  bytes: " + this.bytesLoaded + "/" + this.bytesTotal);
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,this.var_384,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case IOErrorEvent.IO_ERROR:
               this.debug("Load event IO ERROR for file \"" + this.url + "\"");
               if(!this.handleHttpStatus(this.var_384))
               {
         ...
         if(this.var_447 == LibraryLoader.const_1677)
         {
         ...
         if(this.var_447 == LibraryLoader.name_3)
         {
            if(this.prepareLibrary())
            {
               ...
               this.removeEventListeners();
               throttle();
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.var_384,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_647 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_647.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
         ...
         try
         {
            this.var_793 = new XML(bytes.readUTFBytes(bytes.length));
         }
         catch(e:Error)
         {
            if(!retry())
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(this._debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,this.var_384,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         }
      }
      ...
      protected function failure(param1:String) : void
      {
         ...
         throttle();
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.var_384,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         dispatchEvent(new Event(LIBRARY_LOADER_FINALIZE));
      }
