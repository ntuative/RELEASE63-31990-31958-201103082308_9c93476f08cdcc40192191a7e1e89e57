package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_595:Map = new Map();
      
      private static const const_329:Map = new Map();
      
      private static var var_1040:Boolean = false;
      ...
      {
         return const_595.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1040)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_595.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1040 = true;
         }
