package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1484:String = "float";
      
      public static const const_37:String = "Boolean";
      
      public static const const_1546:String = "bool";
      ...
      private static const const_606:String = "key";
      
      private static const const_961:String = "type";
      
      private static const const_607:String = "value";
      
      private static const const_611:String = "true";
      
      private static const const_1720:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_606));
         }
         else
         {
            _loc4_ = param1.child(const_606)[0];
         }
         ...
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_607));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_607)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_235 || _loc5_ == const_147)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_132:
               return uint(param1);
            case const_147:
               return param1.split(const_1318);
            default:
      ...
      public static function parseValueType(param1:XML, param2:String) : Object
      {
         ...
         switch(param2)
         {
            ...
            case const_237:
               ...
               _loc5_.width = Number(param1.attribute(const_1316));
               _loc5_.height = Number(param1.attribute(const_1317));
               return _loc5_;
            case const_147:
               _loc3_ = new Map();
