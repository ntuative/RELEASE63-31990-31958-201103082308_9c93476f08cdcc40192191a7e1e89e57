package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1470:uint = 0;
      
      public static const const_888:uint = 1;
      
      public static const const_987:uint = 2;
      
      public static const const_893:uint = 4;
      
      public static const const_1507:uint = 8;
      
      public static const const_1378:uint = 16;
      
      public static const const_1902:uint = 64;
      
      public static const const_1771:uint = 128;
      
      public static const const_1084:uint = 256;
         ...
         if(this.var_806)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2014,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2014,16777215);
                  }
                  var_324 += bitmap.width * bitmap.height * 4;
               }
