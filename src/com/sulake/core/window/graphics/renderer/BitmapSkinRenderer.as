         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.scaleH == SkinLayoutEntity.const_281)
                  {
                     var_35.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_498)
                  {
                     _loc12_ = true;
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_281)
                  {
                     var_35.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_498)
                  {
                     _loc13_ = true;
                  ...
                  {
                     this.var_942.a = 0 / _loc17_.width;
                     this.var_942.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_35.width,var_35.height,false);
                     _loc30_.draw(_loc17_,this.var_942);
                     _loc31_ = new BitmapData(var_35.width,var_35.height,true,0);
                     _loc31_.draw(_loc18_,this.var_942,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_281)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_281)
               {
