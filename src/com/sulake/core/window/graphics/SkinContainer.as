package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1324:String = "bitmap";
      
      private static const const_1321:String = "fill";
      
      private static const const_1323:String = "text";
      
      private static const const_1325:String = "label";
      
      private static const const_1320:String = "shape";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1843,this.var_2604);
         this.var_2605 = new Dictionary();
         this.var_2603 = new Dictionary();
         StateCodeTable.fillTables(this.var_2605,this.var_2603);
         this.var_424 = new Dictionary();
         this.var_424[const_1322] = BitmapSkinRenderer;
         this.var_424[const_1324] = BitmapDataRenderer;
         this.var_424[const_1321] = FillSkinRenderer;
         this.var_424[const_1323] = TextSkinRenderer;
         this.var_424[const_1325] = LabelRenderer;
         this.var_424[const_1320] = ShapeSkinRenderer;
         this.var_424[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_424[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_325 == null)
         {
            var_325 = new Array();
            var_325.push(WindowState.const_64);
            var_325.push(WindowState.const_82);
            var_325.push(WindowState.const_99);
            var_325.push(WindowState.const_52);
            var_325.push(WindowState.const_97);
            var_325.push(WindowState.const_81);
            var_325.push(WindowState.const_106);
            var_325.push(WindowState.const_101);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2757 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1843[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_933[param1] == null)
         {
            this.var_933[param1] = new Array(const_964);
         }
         this.var_933[param1][param2] = param3;
         if(this.var_934[param1] == null)
         {
            this.var_934[param1] = new Array(const_964);
         }
         this.var_934[param1][param2] = param4;
      }
