package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         this.var_302 = param1;
         if(this.var_302 < int.MAX_VALUE && !this._target.disposed && this._target.width > this.var_302)
         {
      ...
      {
         return this.var_299 == int.MIN_VALUE && this.var_302 == int.MAX_VALUE && this.var_300 == int.MIN_VALUE && this.var_301 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            else if(this._target.width > this.var_302)
            {
               this._target.width = this.var_302;
            }
