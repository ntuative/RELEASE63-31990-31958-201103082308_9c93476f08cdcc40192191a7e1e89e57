package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_191:String = "regular";
      ...
      private static var var_467:Array;
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_85[const_191],var_85[ITALIC],var_85[BOLD]];
            var_85.reset();
            var_85[const_191] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_467.indexOf(_loc4_.name) == -1)
            {
               var_467.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
