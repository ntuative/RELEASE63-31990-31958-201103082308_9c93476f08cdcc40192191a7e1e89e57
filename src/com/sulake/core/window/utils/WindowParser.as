package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1823:String = "_INCLUDE";
      
      public static const const_1738:String = "_TEMP";
      
      private static const const_1333:String = "layout";
      
      private static const const_966:String = "window";
      
      private static const const_968:String = "variables";
      
      private static const const_967:String = "filters";
      
      private static const const_610:String = "name";
      
      private static const const_1335:String = "style";
      
      private static const const_609:String = "params";
      
      private static const const_1342:String = "tags";
      
      private static const X:String = "x";
      
      private static const Y:String = "y";
      
      private static const const_1316:String = "width";
      
      private static const const_1317:String = "height";
      
      private static const const_1339:String = "visible";
      ...
      private static const const_995:String = "blend";
      
      private static const const_1336:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1344:String = "treshold";
      
      private static const const_1338:String = "children";
      
      private static const const_1340:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1334:String = "height_min";
      ...
      private static const const_1318:String = ",";
      ...
      protected var var_1252:Dictionary;
      
      protected var var_1251:Dictionary;
      
      protected var var_1001:Dictionary;
      
      protected var var_1506:Dictionary;
      
      protected var var_2016:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1252,this.var_1251);
         this.var_1001 = new Dictionary();
         this.var_1506 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1001,this.var_1506);
         this.var_2016 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1337,const_48);
         return param1.replace(const_1345,const_48);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1252)
            {
               delete this.var_1252[_loc1_];
            }
            for(_loc1_ in this.var_1251)
            {
               delete this.var_1251[_loc1_];
            }
            for(_loc1_ in this.var_1001)
            {
               delete this.var_1001[_loc1_];
            }
            for(_loc1_ in this.var_1506)
            {
               delete this.var_1506[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         if(param1.localName() == const_1333)
         {
            ...
            _loc9_ = param1.child(const_967).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1252[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_610,variables,"")));
         style = uint(this.parseAttribute(xml,const_1335,variables,style));
         params = uint(this.parseAttribute(xml,const_609,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1342,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_159));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_159));
         rect.width = Number(this.parseAttribute(xml,const_1316,variables,const_159));
         rect.height = Number(this.parseAttribute(xml,const_1317,variables,const_159));
         visible = this.parseAttribute(xml,const_1339,variables,visible.toString()) == const_611;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_609).length() > 0)
         {
            list = xml.child(const_609).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_610,variables,"") as String;
               if(this.var_1001[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_610)) + "\"!");
               }
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_968)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1340,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1334,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1343,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_611;
         blend = Number(this.parseAttribute(xml,const_995,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1336,variables,window.clipping.toString()) == const_611;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1344,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_967).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_48;
         var _loc3_:String = this.var_1251[param1.type];
