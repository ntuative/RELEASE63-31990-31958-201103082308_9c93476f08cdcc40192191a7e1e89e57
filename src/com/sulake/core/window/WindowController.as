package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected var var_656:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_387 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_63 = var_387.clone();
            var_11 = var_387.clone();
         ...
         if(_loc13_)
         {
            var_792 = _loc13_.blend;
            var_450 = _loc13_.var_2757;
      ...
      public static function expandToAccommodateChild(param1:WindowController, param2:IWindow) : void
      {
         ...
         if(_loc8_)
         {
            _loc9_ = param1.getParamFlag(WindowParam.const_73);
            param1.setParamFlag(WindowParam.const_73,false);
            ...
            if(_loc9_)
            {
               param1.setParamFlag(WindowParam.const_73,true);
            }
         }
      }
      ...
      public static function resizeToAccommodateChildren(param1:WindowController, param2:Boolean = true) : void
      {
         ...
         var _loc11_:Boolean = param1.getParamFlag(WindowParam.const_73);
         if(param2)
         {
            _loc3_ = 0;
      ...
      {
         return this.var_656 != null ? this.var_656 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_451 = param1;
         var_233 = !!var_451 ? uint(var_233 | var_533) : uint(var_233 & 16777215);
         this.var_169 = this.var_169 || param1;
         _context.invalidate(this,var_11,WindowRedrawFlag.const_71);
      }
      ...
      {
         var_808 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_547,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_533 = param1 & 4278190080;
         var_233 = !!var_451 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_71);
      }
      ...
      {
         var_533 = param1 << 24;
         var_233 = !!var_451 ? uint(var_533 | var_233) : uint(16777215 & var_233);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_71);
      }
      
      public function set blend(param1:Number) : void
      {
         var_792 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_11,WindowRedrawFlag.const_995);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_587,this,null));
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_84 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_556,this,null));
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_468,this,this._parent));
            }
            else
            {
               this.var_371.x = 0;
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1003,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_888,var_11);
            this.var_22.visible = var_388;
         }
         return this.var_22;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_84,var_19,_context,var_11,null,this.var_656,this.properties,var_807.concat(),_id) as WindowController;
         _loc2_.var_450 = var_450;
         _loc2_.var_169 = this.var_169;
         _loc2_._debug = this._debug;
         _loc2_.var_371 = this.var_371.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_387 = var_387.clone();
         ...
         _loc2_.var_808 = var_808;
         _loc2_.var_388 = var_388;
         _loc2_.var_792 = var_792;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2599 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            _loc7_ = uint(var_19 & 0);
            if(_loc7_ == WindowParam.const_431)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_997,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_824,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_557,this,null));
            }
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_198,this,null));
            }
         }
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_829))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_45:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1203;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_198:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_437,this,null));
                     if(testParamFlag(WindowParam.const_181,WindowParam.const_164))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_193,WindowParam.const_168))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        var_19 = _loc9_;
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_311,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_557:
                  _context.invalidate(this,var_11.union(var_63),WindowRedrawFlag.const_448);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1206,this,null));
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_338:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_862,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_217,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_587:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_992);
                  break;
               ...
               case WindowNotifyEvent.const_547:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_22)
                     {
                        ...
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_448);
                     }
                  }
                  else if(var_19 & 0)
                  {
               ...
               case WindowNotifyEvent.const_351:
                  if(testParamFlag(WindowParam.const_73))
                  {
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1049:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1477:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1493:
               _loc2_ = "null";
               break;
         ...
         if(this.var_169 && var_450 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1434,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1434,param3,param1)) : false;
            }
         }
      ...
      public function expandToAccommodateChildren() : void
      {
         ...
         var _loc8_:Boolean = this.getParamFlag(WindowParam.const_73);
         ...
         if(_loc7_)
         {
            if(_loc8_)
            {
               this.setParamFlag(WindowParam.const_73,false);
            }
            ...
            if(_loc8_)
            {
               this.setParamFlag(WindowParam.const_73,true);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_145,WindowParam.const_164);
         var _loc2_:* = !testParamFlag(WindowParam.const_148,WindowParam.const_168);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_395)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1125,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_351,this,param1));
         return param1;
      }
