package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_894:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_893:String = "default";
      
      private var var_1110:String = null;
      
      private var var_1734:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1110 == param2)
         {
            return;
         }
         param1.var_1110 = param2;
         param1.var_1734 = null;
         if(param1.var_1110 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1110);
            param1.var_1734 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_822.indexOf(param1) > -1)
         {
            this.var_893 = param1;
         }
      }
      ...
      {
         return this.var_893 == LinkTarget.const_31 ? defaultLinkTarget : this.var_893;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1734;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_871)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_893 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_759,this.var_893,PropertyStruct.const_55,true,PropertyDefaults.const_822));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1490);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_759)
            {
               this.var_893 = _loc2_.value as String;
               break;
            }
