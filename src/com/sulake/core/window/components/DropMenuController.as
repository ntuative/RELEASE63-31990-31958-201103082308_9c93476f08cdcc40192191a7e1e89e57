package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_540,this,null,true);
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_184 == null || this.var_184.disposed)
         {
            this.var_184 = context.create(name + "::submenu","",WindowType.const_422,var_84,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_980 = false;
            this.getTitleLabel().text = this.var_643 < this.var_274.length && this.var_643 > -1 ? this.var_274[this.var_643] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_434,var_84,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_387,var_84,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         {
            _loc4_.getListItemAt(this.var_643).setStateFlag(WindowState.const_52,true);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_274.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_777,this.var_274,PropertyStruct.const_147,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1529);
         }
         return _loc1_;
      }
