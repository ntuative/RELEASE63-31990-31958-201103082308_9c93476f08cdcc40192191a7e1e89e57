package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1228:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_809:Number;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_191);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_753 ? true : null;
         }
      ...
      {
         this.var_809 = param1;
         this._field.scrollH = this.var_809 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_809 * this.maxScrollH,this.var_536 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_809 = this.var_809;
         _loc1_.var_536 = this.var_536;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1167) ? new PropertyStruct(PropertyDefaults.const_652,this._field.antiAliasType,PropertyStruct.const_55,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1219) : PropertyDefaults.const_1571);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1225 ? new PropertyStruct(PropertyDefaults.const_786,this._autoSize,PropertyStruct.const_55,true,PropertyDefaults.const_1008) : PropertyDefaults.const_1387);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1021 ? new PropertyStruct(PropertyDefaults.const_1101,this._field.gridFitType,PropertyStruct.const_55,true,PropertyDefaults.const_1045) : PropertyDefaults.const_1528);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_765) ? new PropertyStruct(PropertyDefaults.const_345,this._field.textColor,PropertyStruct.const_132,true) : PropertyDefaults.const_994);
         _loc1_.push(this.var_427 != TextStyleManager.const_191 ? new PropertyStruct(PropertyDefaults.const_354,this.var_427,PropertyStruct.const_55,true,PropertyDefaults.const_684) : PropertyDefaults.const_1043);
         _loc1_.push(this.var_40.left != PropertyDefaults.const_658 ? new PropertyStruct(PropertyDefaults.const_242,this.var_40.left,PropertyStruct.const_40,true) : PropertyDefaults.const_542);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_617 ? new PropertyStruct(PropertyDefaults.const_228,this.var_40.top,PropertyStruct.const_40,true) : PropertyDefaults.const_569);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_717 ? new PropertyStruct(PropertyDefaults.const_247,this.var_40.right,PropertyStruct.const_40,true) : PropertyDefaults.const_450);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_887 ? new PropertyStruct(PropertyDefaults.const_232,this.var_40.bottom,PropertyStruct.const_40,true) : PropertyDefaults.const_524);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1029 ? new PropertyStruct(PropertyDefaults.const_868,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1396);
