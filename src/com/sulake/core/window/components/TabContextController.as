package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1236:String = "_SELECTOR";
      
      private static const const_1237:String = "_CONTENT";
       
      
      protected var var_993:ITabSelectorWindow;
      
      protected var var_1995:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_993 = findChildByTag(const_1236) as ITabSelectorWindow;
            if(this.var_993 != null)
            {
               this.var_993.procedure = this.selectorEventProc;
            }
         }
         return this.var_993;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1995 = findChildByTag(const_1237) as IWindowContainer;
         }
      ...
      {
         return !!this.var_784 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_993.numSelectables;
      }
