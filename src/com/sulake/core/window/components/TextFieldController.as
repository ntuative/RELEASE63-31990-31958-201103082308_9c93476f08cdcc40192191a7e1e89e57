package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1507:uint = 500;
      
      protected var var_1255:String = "";
      
      protected var var_1241:Boolean = false;
      
      protected var var_784:Boolean = false;
      ...
      {
         this.var_1255 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_987,var_11);
         }
         return var_22;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_426)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_784 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_405,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_834,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1501);
         _loc1_.push(this.var_1241 != PropertyDefaults.const_1146 ? new PropertyStruct(PropertyDefaults.const_815,this.var_1241,PropertyStruct.const_37,true) : PropertyDefaults.const_1393);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1005 ? new PropertyStruct(PropertyDefaults.const_723,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1476);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1074 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1580);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_834:
                  ...
                  break;
               case PropertyDefaults.const_1128:
