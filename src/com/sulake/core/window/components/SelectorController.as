package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_194:ISelectableWindow;
      
      protected var var_2001:Boolean = true;
      ...
      {
         return this.var_194 as ISelectableWindow;
      }
      ...
      public function setSelected(param1:ISelectableWindow) : void
      {
         if(param1 != null)
         {
            if(param1 != this.var_194)
            {
               if(this.var_194 != null)
               {
                  this.var_194.unselect();
               }
               this.var_194 = param1;
               this.var_194.select();
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_363,this,this.var_194));
               }
            }
         }
      }
