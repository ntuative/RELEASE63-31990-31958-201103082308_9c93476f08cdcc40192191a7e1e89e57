package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_350:Object = null;
      ...
      protected function get textField() : TextField
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _loc1_.textColor = uint(this.var_350);
            }
         }
         return _loc1_;
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2268 = _loc2_.textWidth;
         this.var_2267 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_350 != _loc2_.color : this.var_350 != null && this.var_350 != PropertyDefaults.const_765) ? new PropertyStruct(PropertyDefaults.const_345,this.var_350,PropertyStruct.const_132,true) : PropertyDefaults.const_994);
         if(this.var_40)
         {
            if(this.var_40.left != PropertyDefaults.const_658)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_242,this.var_40.left,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_542);
            }
            if(this.var_40.top != PropertyDefaults.const_617)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_228,this.var_40.top,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_569);
            }
            if(this.var_40.right != PropertyDefaults.const_717)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_247,this.var_40.right,PropertyStruct.const_40,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_450);
            }
            if(this.var_40.bottom != PropertyDefaults.const_887)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_232,this.var_40.bottom,PropertyStruct.const_40,true));
            }
            else
            {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_345:
                  this.var_350 = _loc2_.value as uint;
                  break;
