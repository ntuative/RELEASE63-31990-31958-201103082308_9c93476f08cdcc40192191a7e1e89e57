package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1271:String = "_TITLE";
      
      private static const const_1359:String = "_HEADER";
      
      private static const const_1361:String = "_CONTENT";
      
      private static const const_1360:String = "_SCALER";
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1271) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1474 = findChildByTag(const_1359) as IHeaderWindow;
            if(!this.var_1474)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_178 = findChildByTag(const_1361) as IWindowContainer;
            if(!this.var_178)
            {
      ...
      {
         return findChildByTag(const_1360) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1227,_loc2_,false);
      ...
      {
         return this.content != null && this.var_994 ? this.content.iterator : new Iterator(this);
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_242,_loc3_.left,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_228,_loc3_.top,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_247,0 - _loc3_.right,PropertyStruct.const_40,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_232,0 - _loc3_.bottom,PropertyStruct.const_40,_loc2_));
         }
         else
         {
