package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2010:Boolean = false;
      ...
      protected var var_2827:Number = 0.0;
      
      protected var var_2826:Number = 0.0;
      
      protected var var_805:Boolean;
      
      protected var var_386:Boolean;
      
      protected var var_998:Boolean;
      
      protected var var_2011:int = 0;
      
      protected var var_2009:int = 0;
      
      protected var var_1248:Number;
      
      protected var var_1249:Number;
      
      protected var var_1247:Boolean = false;
      
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         this._spacing = PropertyDefaults.const_479;
         this.var_805 = PropertyDefaults.const_732;
         this.var_386 = PropertyDefaults.const_820;
         this.var_998 = PropertyDefaults.const_772;
         this.var_655 = 0;
         this.var_654 = 0;
         this.var_106 = 0;
         this.var_94 = 0;
         ...
         var_169 = var_451 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_387,WindowStyle.const_835,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_49,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_520,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_296,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_563,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_998;
      }
      ...
      {
         return new Rectangle(this.var_655 * this.maxScrollH,this.var_654 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_655 = param1;
            this._container.x = -this.var_655 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_71);
            dispatchEvent(new WindowEvent(WindowEvent.const_516,this,null));
         }
      }
      ...
      {
         this.var_2827 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2826 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_462,param1);
            }
            else
            {
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_520,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_296,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_173:
               if(this.var_1247)
               {
                  this.var_1248 = this.var_2011 - _loc3_;
                  this.var_1249 = this.var_2009 - _loc4_;
                  if(this._horizontal)
                  {
                  ...
                  else if(this.var_1249 != 0 && this.var_94 != 0)
                  {
                     this.scrollV += this.var_1249 / this.var_94;
                  }
                  this.var_2011 = _loc3_;
                  this.var_2009 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_201:
               if(this.var_1247)
               {
                  ...
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1249);
                  }
                  this.var_1247 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_805 && !this.var_532 && this._container)
         {
            this.var_532 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_479)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_372,this._spacing,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1171);
         }
         if(this.var_805 != PropertyDefaults.const_732)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_891,this.var_805,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1543);
         }
         if(this.var_386 != PropertyDefaults.const_820)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_790,this.var_386,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1433);
         }
         if(this.var_998 != PropertyDefaults.const_772)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_795,this.var_998,PropertyStruct.const_37,true));
         }
         else
         {
