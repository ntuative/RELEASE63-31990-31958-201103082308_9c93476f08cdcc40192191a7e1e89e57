package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1151:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_422)
         {
            this.var_422.removeEventListener(WindowEvent.const_308,this.scrollBarEventProc);
            this.var_422.removeEventListener(WindowEvent.const_226,this.scrollBarEventProc);
            this.var_422 = null;
         }
         if(this.var_1151)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1151)
         {
            this.var_1151 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_422)
         {
            ...
            if(this.var_422)
            {
               this.var_422.addEventListener(WindowEvent.const_308,this.scrollBarEventProc);
               this.var_422.addEventListener(WindowEvent.const_226,this.scrollBarEventProc);
            }
         }
         return this.var_422;
      }
