package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1551:int = 10000;
      ...
      private var var_490:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_356 = new Timer(const_1551,1);
         this.var_356.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_490)
         {
            this.var_490.connectionInit(param1,param2);
         }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         if(this.var_490)
         {
            this.var_490.messageSent(String(_loc4_),_loc5_.toString());
         }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_720.getMessages(this.var_489,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_490)
               {
                  this.var_490.messageReceived(String(id),data.toString());
               }
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         _loc2_.text = "Socket Timeout (" + this.var_356.delay + " ms). Possible Firewall.";
