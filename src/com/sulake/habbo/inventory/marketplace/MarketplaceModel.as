package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function getItemStats() : void
      {
         ...
         this.var_2659 = _loc2_;
         this.var_2665 = this.var_221.type;
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this.var_17.showMakeOffer(this.var_221);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this.var_17.showBuyTokens(this.var_1934,this.var_1933);
         }
      }
      ...
      {
         if(param1 != this.var_2659 || param2 != this.var_2665)
         {
            return;
         }
         if(!this.var_17)
         ...
         this.var_17.updateAveragePrice(param3,this.var_2658);
      }
