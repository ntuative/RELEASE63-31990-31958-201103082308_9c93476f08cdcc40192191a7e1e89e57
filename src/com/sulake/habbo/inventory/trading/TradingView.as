package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_949:uint = 4284532064;
      
      private static const const_948:uint = 2577770;
      
      public static const const_1169:int = 0;
      
      public static const const_1220:int = 1;
      
      public static const const_1106:int = 2;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1774 = this.createMinimizedWindow();
         }
         if(!this.var_2498)
         {
            return this.var_70;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_70)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_949) : uint(const_948);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_949) : uint(const_948);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1163)
            {
            ...
            this.var_421.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_527);
            this.var_421.show();
         }
