package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_400:String = "pets";
      ...
      private var var_1733:Vector.<Array>;
      
      private var var_1732:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_229,this.onObjectPlaced);
         this._catalog = param7;
         this.var_589 = new Timer(const_1274,1);
         ...
         this.var_2419 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_229,this.onObjectPlaced);
               }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_44)
            {
               ...
               {
                  this.var_1733 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1733;
            }
            else
            {
               if(this.var_1732 == null)
               {
                  this.var_1732 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1732;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_388)
         {
         ...
         if(this.var_892 == null)
         {
            this.var_892 = this._windowManager.buildFromXML(this.var_2419) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_892.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_44,const_50];
         var _loc5_:int = 0;
         ...
         if(param1 == InventoryCategory.const_76 && this._controller.isVisible)
         {
            switch(this.var_17.visibleCategoryId)
            {
               ...
               case const_50:
                  ...
                  break;
               case const_400:
                  this._controller.toggleInventoryPage(InventoryCategory.const_126);
            }
         }
      }
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_44,const_50];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_44,const_50];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_588.add(const_44,new Array());
         this.var_588.add(const_50,new Array());
         if(this.var_17 != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_388 || _loc3_.category == FurniCategory.const_381 || _loc3_.category == FurniCategory.const_357)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1378 && param1.type == RoomEngineObjectEvent.const_229)
         {
            this.var_1378 = false;
         }
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_588.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_896)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
