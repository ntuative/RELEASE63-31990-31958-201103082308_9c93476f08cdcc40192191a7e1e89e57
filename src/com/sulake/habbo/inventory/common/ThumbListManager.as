package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1433:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_616 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_616.width;
         this.var_92 = this.var_616.height;
         this.var_1174 = param5;
         this.var_932 = param6;
         this.var_224 = Math.floor(this.var_1174 / this._thumbWidth);
         this.var_26 = new BitmapData(this.var_1174,this.var_932);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_26 = new BitmapData(Math.max(this.var_224 * this._thumbWidth,this.var_1174),Math.max(this.var_617 * this.var_92,this.var_932),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_224 && this.var_26.height < _loc3_.y * this.var_92)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_224 - 1),this.var_92);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_224 - 1),0,this._thumbWidth,this.var_26.height);
         _loc2_.copyPixels(this.var_26,_loc4_,new Point(0,this.var_92),null,null,true);
         _loc4_ = new Rectangle(0,this.var_92,this._thumbWidth * (this.var_224 - 1),this.var_26.height - this.var_92);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1433.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_26.height < this.var_932)
         {
            _loc12_ = new BitmapData(this.var_26.width,this.var_932);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_616.width,this.var_616.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_616.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_616,this.var_616.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
