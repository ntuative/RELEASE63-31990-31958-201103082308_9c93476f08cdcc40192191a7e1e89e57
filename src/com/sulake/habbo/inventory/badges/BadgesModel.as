   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_306.getBadgeImage(param1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = this.var_248[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < this.var_248.length)
               {
                  if((this.var_248[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(this.var_248[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
