package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_958:uint = 11;
      ...
      private var var_49:IRoomWidgetFactory;
      ...
      private var var_1155:IHabboWindowManager;
      ...
      private var var_611:FramerateTracker = null;
      
      private var var_262:LatencyTracker = null;
      
      private var var_612:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_611 = new FramerateTracker();
         this.var_262 = new LatencyTracker();
         this.var_612 = new LagWarningLogger();
         this.var_610 = new ToolbarClickTracker(this);
         this.var_1421 = new Array(const_958);
         var _loc4_:int = 0;
         while(_loc4_ < const_958)
         {
            this.var_1421[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1584,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1554,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_876,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1154,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1155)
            {
               this.var_1155.release(new IIDHabboWindowManager());
               this.var_1155 = null;
            }
            if(this.var_313)
            {
            ...
            if(this.var_49)
            {
               this.var_49.release(new IIDHabboRoomWidget());
               this.var_49 = null;
            }
            if(this._navigator)
            {
            ...
            if(this.var_200)
            {
               if(!this.var_200.disposed)
               {
                  ...
                  Component(this.var_200).events.removeEventListener(HabboFriendListTrackingEvent.const_344,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_179)
            {
               ...
               {
                  this.var_179.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_177)
         {
            if(this.var_262 != null)
            {
               this.var_262.configuration = this.var_177;
            }
            if(this.var_261 != null)
            {
               this.var_261.configuration = this.var_177;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1527);
            if(this.var_177)
            {
               if(this.var_612 != null)
               {
                  this.var_612.configure(this.var_177);
               }
               if(this.var_611 != null)
               {
                  this.var_611.configure(this.var_177);
               }
               if(this.var_610 != null)
               {
                  this.var_610.configure(this.var_177);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_736,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_779,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_612 != null)
            {
               this.var_612.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_779)
         {
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1556);
               break;
            case HabboCommunicationEvent.const_736:
      ...
      {
         this.var_1155 = IHabboWindowManager(param2);
         if(this.var_1155)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_177)
            {
               if(this.var_177.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1421)
                  {
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_200).events.addEventListener(HabboFriendListTrackingEvent.const_344,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_344:
      ...
      {
         this.var_49 = param2 as IRoomWidgetFactory;
         Component(this.var_49).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE,this.onWidgetTrackingEvent);
         Component(this.var_49).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT,this.onWidgetTrackingEvent);
         Component(this.var_49).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE,this.onWidgetTrackingEvent);
         Component(this.var_49).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS,this.onWidgetTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1154,String(_loc2_.guestRoomId));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_313.events.addEventListener(AdEvent.const_423,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_179 = param2 as IHabboToolbar;
         this.var_179.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClick);
      }
      ...
      {
         this.var_612.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_506 > -1 && _loc2_ < this.var_506)
         {
            ++this.var_1815;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1815);
         }
         if(this.var_506 > -1 && _loc2_ - this.var_506 > 15000)
         {
            ++this.var_1816;
         ...
         if(this.var_261 != null)
         {
            this.var_261.update(param1,this.var_506);
         }
         if(this.var_262 != null)
         {
            this.var_262.update(param1,this.var_506);
         }
         if(this.var_611 != null)
         {
            this.var_611.trackUpdate(param1,this,this.var_506);
         }
         if(this.var_612 != null)
         {
            this.var_612.update(this.var_506);
         }
      }
   }
}
