package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_1840:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_91.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               ...
               this.var_1840 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
      ...
      private function setText(param1:String, param2:String, param3:Boolean = true, param4:Boolean = false) : void
      {
         ...
         if(_loc5_)
         {
            ...
            if(param4 && _loc5_ is IHTMLTextWindow)
            {
               ...
               (_loc5_ as IHTMLTextWindow).linkTarget = LinkTarget.const_871;
            }
         }
      }
      ...
      private function onResized(param1:WindowEvent, param2:IWindow = undefined) : void
      {
         this.updateMargins();
      }
   }
