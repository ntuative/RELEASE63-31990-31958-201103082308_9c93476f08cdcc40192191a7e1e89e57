package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1447:uint = 7645971;
      
      private var var_1854:uint = 6710886;
      
      private var var_193:IWindow;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1520 = param1.roomItemTypeName;
         this.var_1519 = param1.rewardCurrencyAmount;
         this.var_1853 = new Date();
         this.var_1853.setTime(param1.endDateTimeStamp);
         this.var_662 = param1.localizationCode;
         this.var_2024 = param1.questBadgeAchievementTypeId;
         this.updateView();
      }
      ...
      private function createView() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_1447 = _loc1_.color;
         }
         var _loc2_:IWindow = this.var_17.findChildByTag("SELECTION_BORDER");
         if(_loc2_ != null)
         {
            this.var_1854 = _loc2_.color;
            this.var_193 = _loc2_;
         }
         else
         {
            this.var_193 = this.var_17;
         }
         this.var_193.color = this.var_1447;
      }
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_60.code,this.var_662].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_194)
            {
               this.var_193.color = this.var_1854;
            }
         }
