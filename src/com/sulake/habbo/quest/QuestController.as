package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_307.attachTo(this.var_1166);
         var _loc1_:String = "quest_" + this.var_307.code;
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_1166 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_156.getKeys())
         {
            ...
            if(!_loc2_)
            {
               ...
               _loc2_ = this.var_65.windowManager.createWindow("tab_" + _loc4_,"${" + _loc6_ + "}",WindowType.const_534) as ITabButtonWindow;
               if(_loc3_.expired)
               {
