package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_497:IKeyExchange;
      
      private var var_901:String;
      
      private var var_17:HabboLoginDemoView;
      
      private var var_2471:PseudoRandom;
      ...
      private const const_1711:String = "fuselogin";
      ...
      public function get method_14() : IHabboCommunicationManager
      {
         return this.var_55;
      }
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_594 = param1;
            this.var_55.initConnection(HabboConnectionType.const_269);
         }
      }
      ...
      {
         if(this.var_55 && this.var_151 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_594 = this.var_151.getKey("sso.ticket",null);
         this.var_1761 = this.var_151.getKey("flash.client.url","");
         this.var_2472 = this.var_151.getKey("external.variables.txt","");
         if(this.var_220 == null)
         {
            this.var_220 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this.var_17.addEventListener(HabboLoginDemoView.const_545,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_55.mode = HabboConnectionType.const_1071;
            }
         }
         this.var_55.initConnection(HabboConnectionType.const_269);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_736);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2471 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_55.mode)
         {
            case HabboConnectionType.const_93:
               ...
               this.var_1391 = _loc4_;
               this.var_220.loadBannerImage(_loc7_ + "?token=" + this.var_1391,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1071:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1449:
               this.var_901 = this.generateRandomHexString(30);
               this.var_497 = new DiffieHellman(new BigInteger(this.var_151.getKey("connection.development.prime"),16),new BigInteger(this.var_151.getKey("connection.development.generator"),16));
               this.var_497.init(this.var_901);
               _loc8_ = this.var_497.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_497.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_497.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2471);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1761,this.var_2472));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1711,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2473)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1391);
         ...
         this.var_497 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_497.init(_loc14_);
            _loc15_ = this.var_497.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_901 = _loc14_;
            }
