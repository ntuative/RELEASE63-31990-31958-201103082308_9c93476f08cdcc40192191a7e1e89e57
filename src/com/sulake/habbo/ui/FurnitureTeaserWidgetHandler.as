package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_867,RoomWidgetViralFurniMessage.const_884,RoomWidgetViralFurniMessage.const_170];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_867:
               ...
               break;
            case RoomWidgetViralFurniMessage.const_884:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_487,RoomSessionViralFurniStatusEvent.const_507];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_487:
