   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_299,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_676,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_811,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_179 != null)
            {
               this.var_179.events.removeEventListener(HabboToolbarEvent.const_72,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_451,this.onHelpTutorialEvent);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_299,this.onFigureUpdate);
         }
         ...
         if(this._inventory != null)
         {
            ...
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_811,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_451,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this.var_179 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1056,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_910);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_721);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_754);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_841);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_734);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_866);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_365);
         _loc1_.push(RoomWidgetStopEffectMessage.const_700);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1553);
         ...
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1672);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1102);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_743);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_650);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_853);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1577);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_791);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_819);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_818);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_650:
            ...
            case RoomWidgetWaveMessage.const_813:
               ...
               break;
            case RoomWidgetDanceMessage.const_910:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_721:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_754:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_841:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_866:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1110:
                        this._catalog.openCatalogPage(CatalogPageName.const_1590,true);
                        break;
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1562:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1523:
                        break;
                     default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1039:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_743:
               if(this._container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_905:
               ...
               {
                  this.var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_546,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_399:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_505));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_853:
            ...
            case RoomWidgetClothingChangeMessage.const_362:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_718));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_666));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_451:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_454));
         }
      }
