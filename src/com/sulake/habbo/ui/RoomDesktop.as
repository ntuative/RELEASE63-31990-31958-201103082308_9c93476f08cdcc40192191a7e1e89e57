package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1033:IRoomWidgetFactory = null;
      ...
      private var var_1062:IHabboHelp = null;
      ...
      private var var_208:IToolTipWindow;
      
      private var var_2123:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_386,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_466,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_739,this.onRoomContentLoaded);
         }
      }
      ...
      {
         this.var_179 = param1;
         this.var_179.events.addEventListener(HabboToolbarEvent.const_494,this.onToolbarRepositionEvent);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_49 != null)
         {
            ...
            {
               _loc5_ = this.var_49.getWithIndex(_loc1_) as IRoomWidget;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(this.var_471 != null)
         {
            ...
            {
               _loc6_ = this.var_471.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_386,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_466,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_739,this.onRoomContentLoaded);
         }
         ...
         {
            this.var_179.events.removeEventListener(HabboToolbarEvent.const_494,this.onToolbarRepositionEvent);
            this.var_179.events.removeEventListener(HabboToolbarEvent.const_36,this.onHabboToolbarEvent);
         }
         this.var_179 = null;
      ...
      public function init() : void
      {
         ...
         if(this.var_313 != null && this.var_30.state == RoomSessionEvent.const_236)
         {
            this.var_1591 = !this.var_313.showInterstitial();
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1033.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(!this.var_49.add(param1,_loc2_))
         {
            _loc2_.dispose();
         }
         switch(param1)
         ...
         if(_loc3_ != null)
         {
            ...
            if(!this.var_471.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
            _loc6_ = null;
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = this.var_679.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_679.add(_loc9_,_loc6_);
                  }
                  else
                  {
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_731:
               ...
               if(this.var_944 != null && _loc3_ == RoomObjectCategoryEnum.const_33)
               {
            ...
            case RoomEngineObjectEvent.const_627:
               if(!this.var_30.isRoomController && !this.var_306.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_152:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1109,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineEvent.const_499:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_356,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_682);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_859);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_642);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_796);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_276,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2123);
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc3_ == MouseEvent.MOUSE_MOVE && this.var_208 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(-this.var_208.width / 2,15);
            this.var_208.setGlobalPosition(_loc8_);
         }
      }
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < this.var_471.length)
         {
            _loc2_ = this.var_471.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         if(this.var_15 != null && this.var_30 != null && this.var_1591 && this.var_1593)
         {
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_379);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_445:
               ...
               this.var_208 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_401,WindowStyle.const_835,WindowParam.const_96) as IToolTipWindow;
               this.var_208.setParamFlag(WindowParam.const_30,false);
      ...
      {
         var _loc3_:IRoomWidget = this.var_49[param1];
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IRoomWidget = this.var_49[param1];
         if(_loc2_ == null)
         {
            return const_470;
         }
