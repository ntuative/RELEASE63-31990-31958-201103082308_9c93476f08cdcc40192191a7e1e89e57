package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1033:IRoomWidgetFactory;
      ...
      private var var_1856:IHabboAvatarEditor = null;
      ...
      private var var_1062:IHabboHelp;
      
      private var var_944:IHabboModeration;
      
      private var _config:IHabboConfigurationManager;
      
      private var var_551:IHabboSoundManager;
      ...
      private var var_1191:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1450 = RoomDesktop.const_470;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1033.release(new IIDHabboRoomWidget());
            this.var_1033 = null;
         }
         ...
         {
            this.var_551.release(new IIDHabboSoundManager());
            this.var_551 = null;
         }
         ...
         {
            this.var_1062.release(new IIDHabboHelp());
            this.var_1062 = null;
         }
         ...
         if(this.var_1191)
         {
            this.var_1191.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1191 = null;
         }
         this.var_1856 = null;
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1033 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1856 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_313.events.addEventListener(AdEvent.const_513,this.adEventHandler);
            this.var_313.events.addEventListener(AdEvent.const_456,this.adEventHandler);
            this.var_313.events.addEventListener(AdEvent.const_423,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1062 = param2 as IHabboHelp;
      }
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_551 = param2 as IHabboSoundManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            ...
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_583,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_586,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_487,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1092,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_702,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_662,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_430,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionWelcomeGiftEvent.const_121,this.roomSessionEventHandler);
         }
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_98:
               if(param1.session != null)
               {
                  ...
                  this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_135,HabboToolbarIconEnum.ZOOM));
                  this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_135,HabboToolbarIconEnum.MEMENU));
                  this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_135,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      {
         this.var_1191 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_697,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_771,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_690,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_731,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_229,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_424,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_499 || param1.type == RoomEngineEvent.const_543)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_697:
               _loc5_ = false;
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_872);
               ...
               if(this._config.getKey("purse.widget.enabled","0") == "1")
               {
                  ...
                  _loc3_.initializeWidget(RoomWidgetEnum.const_350);
               }
               if(!_loc5_)
               {
               ...
               if(this.var_1450 != RoomDesktop.const_470)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_303,this.var_1450);
               }
               if(this.var_313 != null)
               {
               ...
               break;
            case RoomEngineEvent.const_771:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1033;
         _loc3_.sessionDataManager = this.var_306;
         ...
         _loc3_.avatarEditor = this.var_1856;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_313;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1062;
         _loc3_.moderation = this.var_944;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_551;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1191;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_303);
