package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomQueueMessage.const_644);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomQueueMessage.const_644:
            ...
            case RoomWidgetRoomQueueMessage.const_762:
               this._container.roomSession.changeQueue(RoomSessionQueueEvent.const_993);
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_518:
               ...
               {
                  case RoomSessionQueueEvent.const_993:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc5_.length > 1)
               {
                  if(_loc4_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_1135) != -1)
                  {
                  ...
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1640) + 1;
                  }
               }
               else
               {
