package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_755);
         _loc1_.push(RoomWidgetFurniActionMessage.const_800);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_685);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_618);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_719);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_574);
         ...
         _loc1_.push(RoomWidgetChangeMottoMessage.const_869);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_394 || param1.type == RoomWidgetUserActionMessage.const_442 || param1.type == RoomWidgetUserActionMessage.const_558)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_792:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1108,_loc3_.name);
            ...
            case RoomWidgetGiveBadgeMessage.GIVE_BADGE:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_755:
            ...
            case RoomWidgetUserActionMessage.const_394:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_685:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_618:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_719:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_298);
               _loc6_.id = param1.id;
               ...
               {
                  _loc24_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_368);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1058);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1042);
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_580);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_125)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_149)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc31_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_761);
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1061;
                  }
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1107;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1454);
               }
               else
               {
