   ...
   public class MessengerView implements IDisposable
   {
      ...
      public function openMessenger() : void
      {
         ...
         if(this.var_16 == null)
         {
            this.prepareContent();
            this.refresh();
            this.var_136.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.MESSENGER,this.var_16));
         }
         else
         {
            this.refresh();
      ...
      {
         this.var_16 = IFrameWindow(this.var_136.getXmlWindow("main_window"));
         ...
         this.var_945 = new ConversationsTabView(this.var_136,this.var_16);
         this.var_945.refresh();
         this.var_935 = ITextFieldWindow(this.var_16.findChildByName("message_input"));
         this.var_935.addEventListener(WindowKeyboardEvent.const_197,this.onMessageInput);
         this.var_1451 = new ConversationView(this.var_136,this.var_16);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_760,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1086,true);
      }
      ...
      private function onMessageInput(param1:Event) : void
      {
         ...
         {
            _loc4_ = 120;
            _loc5_ = this.var_935.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_935.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      private function sendMsg() : void
      {
         ...
         this.var_935.text = "";
         this.var_136.conversations.addMessageAndUpdateView(new Message(Message.const_873,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
