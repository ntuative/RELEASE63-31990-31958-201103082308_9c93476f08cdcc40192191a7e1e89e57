package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_980:int = 100;
      
      private static const const_1363:int = 20;
       
      
      private var var_136:HabboMessenger;
      
      private var var_2711:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_136 = param1;
         this.var_1911 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_58 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2711 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_980 + const_1363)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1911.enable();
         }
         else
         {
            this.var_1911.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_58.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_517.messages.length - const_980);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_873 || param3.type == Message.const_643 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_136.send(new FollowFriendMessageComposer(this.var_517.id));
      }
