package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1494:LogoutController;
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_288.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_1494 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this.var_17 == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_139,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1056,this.onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_1038,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1209,this.onHideWindowEvent);
         this._state = true;
