package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_485:String = "LEFT";
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         this.var_211 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_63,HabboWindowStyle.const_1139,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1070 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1070)
         {
         ...
         this.var_1071 = _loc6_.toolbar.@margin_top;
         this.var_1348 = _loc6_.toolbar.@margin_bottom;
         this.var_1675 = _loc6_.toolbar.@min_group_margin;
         this.var_1676 = _loc6_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc7_,this.var_249,param1,param2,this._window,this.var_284);
         this.createGroupsFromXmlList(_loc8_,this.var_573,param1,param2,this.var_211,this.var_284);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_146,this.var_485,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_485);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_146,this.var_485);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_146,this.var_485);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_1214);
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_211.x = this.var_146 + this.var_1676;
               this.var_211.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_211.x = 0;
               this.var_211.y = this.var_146 + this.var_1676;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1071;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_249.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1675,(this._window.height - _loc5_ * _loc8_ - this.var_1071 - this.var_1348) / (this.var_249.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1675,(this._window.width - _loc5_ * _loc8_ - this.var_1071 - this.var_1348) / (this.var_249.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_249.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_485;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1070 && this.var_1349)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_485)
            {
               this.var_485 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_494);
                  _loc3_.orientation = this.var_485;
