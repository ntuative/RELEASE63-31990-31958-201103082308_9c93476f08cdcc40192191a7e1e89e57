package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_546:ToolbarBarMenuAnimator;
      ...
      private var var_2099:int = 5;
      
      private var var_2687:int;
      
      private var var_146:Number;
      
      private var var_2688:XML;
      ...
      {
         var _loc1_:* = null;
         while(this.var_316.length > 0)
         {
            this.var_778.shift();
            _loc1_ = this.var_316.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2688.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_778.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      {
         return this.var_778.indexOf(param1) > -1;
      }
      ...
      public function get size() : Number
      {
         ...
         {
            if(this.var_316[_loc2_].exists)
            {
               _loc1_ += this.var_1464;
            }
            _loc2_++;
         }
         return _loc1_;
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1465.length)
         {
            _loc2_ = this.var_778.indexOf(this.var_1465[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_316[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1193 + _loc3_);
                  _loc3_ += this.var_1464;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_316[this.var_778.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,this._windowManager,this._assetLibrary,param1,this._events,this.var_546);
         this.var_41.addChild(_loc2_.window);
         this.var_778.push(param1);
         this.var_316.push(_loc2_);
         return _loc2_;
      }
   }
}
