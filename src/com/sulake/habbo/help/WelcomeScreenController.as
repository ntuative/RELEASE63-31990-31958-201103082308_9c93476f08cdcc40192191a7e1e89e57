package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      public function WelcomeScreenController(param1:HabboHelp, param2:IHabboWindowManager, param3:IHabboConfigurationManager)
      {
         ...
         this._config = param3;
         this.var_135.toolbar.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClicked);
         this.var_135.toolbar.events.addEventListener(HabboToolbarEvent.const_1214,this.onToolbarResized);
         var _loc4_:Boolean = Boolean(parseInt(this._config.getKey("new.identity","0")));
         this.var_1787 = Boolean(parseInt(this._config.getKey("welcome.screen.enabled","0"))) && _loc4_;
         this.var_2712 = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this._targetLoc = new Point(72,10);
         this.var_198 = new Timer(this.var_2712,1);
         this.var_198.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTimerComplete);
         this.var_1218 = HabboToolbarIconEnum.NAVIGATOR;
         this.var_1475 = "";
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_135)
         {
            this.var_135.toolbar.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClicked);
            this.var_135 = null;
         }
      ...
      public function setCategory(param1:String, param2:String = "", param3:String = "") : void
      {
         ...
         {
            this.var_1912 = "welcome.screen.title";
         }
         if(param3.length > 0)
         {
         ...
         {
            this.var_1475 = "welcome.screen.message";
         }
      }
      ...
      private function onTimerComplete(param1:TimerEvent) : void
      {
         ...
         this.var_1787 = false;
         this._targetLoc.y = this.var_135.toolbar.getIconLocation(this.var_1218) - this._window.height / 2;
         this._window.y = this._targetLoc.y;
         this._window.findChildByName("title").caption = "${" + this.var_1912 + "}";
         this._window.findChildByName("text").caption = "${" + this.var_1475 + "}";
         this.highlightToolbarIcon(true);
      }
      
      private function highlightToolbarIcon(param1:Boolean) : void
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_88,this.var_1218);
