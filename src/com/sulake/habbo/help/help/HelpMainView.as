package com.sulake.habbo.help.help
{
   ...
   public class HelpMainView extends HelpViewController
   {
      ...
      private static const const_1260:int = 60;
      ...
      override public function render() : void
      {
         ...
         if(_loc6_ == null || _loc6_.getFrontPageUrgentCategory().getAgeSeconds() > const_1260)
         {
      ...
      private function onCallForHelp(param1:WindowMouseEvent) : void
      {
         ...
         main.showUI(HabboHelpViewEnum.const_385);
      }
