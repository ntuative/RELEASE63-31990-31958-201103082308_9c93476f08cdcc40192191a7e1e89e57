package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201103082302));
         this.var_179 = param5;
         this.var_107 = new Map();
         this.var_107.add(HabboHelpViewEnum.const_1669,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_185,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_443,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_312,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_249,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_385,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_849,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_254,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_107.add(HabboHelpViewEnum.const_1080,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_107.add(HabboHelpViewEnum.const_1030,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_107.add(HabboHelpViewEnum.const_847,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_456.length == 0 || param1 != this.var_328)
            {
               this.var_456.push(this.var_328);
            }
         }
         this.var_328 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_254:
               ...
               break;
            case CallForHelpResultEnum.const_1022:
               this.showUI(HabboHelpViewEnum.const_1030);
               break;
            case CallForHelpResultEnum.const_1118:
               this.showUI(HabboHelpViewEnum.const_1080);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_107.getValue(HabboHelpViewEnum.const_185) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_529));
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2021 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2022;
         this._window.width = _loc1_.width + this.var_2021;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_456.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_328 == HabboHelpViewEnum.const_185)
         {
            return;
         }
         if(this.var_540.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_540.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_540[1],this.var_540[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_540[0],this.var_540[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_328 == HabboHelpViewEnum.const_185 || this.var_456.length == 0)
         {
            return;
         }
         if(this.var_327 == null)
