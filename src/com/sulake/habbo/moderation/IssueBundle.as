package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_712:IssueMessageData = null;
      
      private var var_713:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2309 = param2.pickerUserId;
         this.var_2323 = param2.pickerUserName;
         this.var_1431 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1083 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1084;
         }
         if(this.var_712 == null || param1.timeStamp < this.var_712.timeStamp)
         {
            this.var_712 = param1;
         }
         if(this.var_713 == null || param1.priority > this.var_713.timeStamp)
         {
            this.var_713 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_713;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_712;
         if(_loc2_ == null)
         {
