package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_927:Array = [];
      
      private static var var_1825:int = 1000;
      
      private static var var_926:Array = [];
      
      private static var var_1823:int = 200;
      ...
      private var var_1824:IMessageComposer;
      ...
      {
         this.var_751 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_750 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         ...
         this.var_34.connection.send(this.var_1824);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_927.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_926.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1826[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
