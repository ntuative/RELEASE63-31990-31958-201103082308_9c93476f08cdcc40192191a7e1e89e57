package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_953:int = 60;
      
      private static const const_950:int = 3600;
      
      private static const const_951:int = 86400;
      
      private static const const_952:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_953) + " mins ago";
         }
         if(param1 < 2 * const_951)
         {
            return Math.round(param1 / const_950) + " hours ago";
         }
         if(param1 < 2 * const_952)
         {
            return Math.round(param1 / const_951) + " days ago";
         }
         return Math.round(param1 / const_952) + " years ago";
      }
      ...
      private function prepare() : IWindowContainer
      {
         ...
         _loc1_.findChildByName("view_caution_count_txt").procedure = this.method_12;
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_34,WindowTracker.const_1023,this._data.userId),this._callerFrame,this.var_1134,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new SendMsgsCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1397),this._callerFrame,this.var_1134,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ModActionCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1397),this._callerFrame,this.var_1134,false,true);
      }
