package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_582:Boolean = true;
      
      private var var_817:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_358));
      ...
      public function populate() : void
      {
         ...
         this.var_817 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1262 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1263 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_709,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_582 || this.var_498.text == "")
         {
            this.var_34.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_817.isSelected);
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1652,_loc2_,this.var_498.text,"",""));
         if(this.var_1262.isSelected || this.var_1263.isSelected || this.var_817.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1262.isSelected,this.var_1263.isSelected,this.var_817.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1481);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1010.selection];
         if(_loc3_ != null)
         {
            this.var_582 = false;
