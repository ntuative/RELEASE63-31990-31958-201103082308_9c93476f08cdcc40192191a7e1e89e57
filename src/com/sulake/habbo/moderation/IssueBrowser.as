package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1979:String = "open_issues";
      
      private const const_1980:String = "picked_issues";
      
      private const const_2022:String = "closed_issues";
      ...
      private var var_1583:IIssueBrowserView;
      
      private var var_1581:IIssueBrowserView;
      
      private var var_1582:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_337.view.width = this.var_239.container.width;
         this.var_337.view.height = this.var_239.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1978:
               ...
               {
                  this.var_1583 = new MyIssuesView(this.issueManager,this,this.var_239.container);
               }
               return this.var_1583;
            case this.const_1979:
               if(this.var_1581 == null)
               {
                  this.var_1581 = new OpenIssuesView(this.issueManager,this,this.var_239.container);
               }
               return this.var_1581;
            case this.const_1980:
               if(this.var_1582 == null)
               {
                  this.var_1582 = new PickedIssuesView(this.issueManager,this,this.var_239.container);
               }
