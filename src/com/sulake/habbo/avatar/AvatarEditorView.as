package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1499:IWindowContainer;
      
      public static var var_1965:int = 6710886;
      ...
      private var var_473:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1036 = [];
         this.var_1306 = [AvatarEditorFigureCategory.const_729,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_216,AvatarEditorFigureCategory.const_802,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_103];
         super();
         ...
         if(var_1499 == null)
         {
            ...
            var_1499 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_403 = new Timer(1000);
         this.var_403.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1306;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_403.stop();
            this.var_403.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_403 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1306);
         }
         if(param1.length != this.var_1036.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1036.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2134 = this.canChangeOutfit();
            this.var_403.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(_loc4_ != null && this.var_1036.indexOf(_loc4_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1306;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_41) && (this.var_1600 == AvatarEditorSideCategory.const_103 || this.var_2135))
         {
      ...
      {
         if(this.var_1600 == AvatarEditorSideCategory.const_103)
         {
            this.var_2135 = false;
            this.setSideContent(AvatarEditorSideCategory.const_787);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_787:
               break;
            case AvatarEditorSideCategory.const_551:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_551);
               break;
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_473)
         {
            ...
            this.var_473 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_473.procedure = this.stripClubDialogEventProc;
            this.var_473.center();
         }
         else
         {
