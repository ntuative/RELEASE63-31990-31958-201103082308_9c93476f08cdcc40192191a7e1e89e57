package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_429:AvatarRenderManager;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_939:AvatarActionManager;
      
      private var var_373:FigureData;
      
      private var var_426:PartSetsData;
      
      private var var_282:AnimationData;
      
      private var var_761:AnimationManager;
      
      private var var_936:ActionDefinition;
      
      private var var_511:String;
      
      private var var_1443:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         ...
         this.var_282 = new AnimationData();
      ...
      {
         this.var_1443.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_939 = new AvatarActionManager(param1,this.var_511,param2);
         this.var_936 = this.var_939.getDefaultAction();
      }
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         ...
         return this.var_282.parse(param1);
      }
      ...
      {
         return this.var_939.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_939.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_939.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_619[param1] = new Dictionary();
         }
         if(this.var_619[param1][param2])
         {
            return this.var_619[param1][param2];
         }
         this.var_619[param1][param2] = this.var_373.getMandatorySetTypeIds(param1,param2);
         return this.var_619[param1][param2];
      }
      ...
      {
         return this.var_939.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1397[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc13_:* = [0];
         var _loc14_:AnimationAction = this.var_282.getAction(param3.definition);
      ...
      {
         return this.var_1443.getOffset(param1,param2,param3,param4,param5,param6);
      }
