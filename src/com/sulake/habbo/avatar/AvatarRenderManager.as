package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2014:String = "hd-99999-99999";
      ...
      private var var_731:PaletteManager;
      ...
      private var var_1744:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_567 = RenderMode.const_1660;
         ...
         this.var_731 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_104.method_1())
            {
               _loc1_.dispose();
            }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_984)
         {
            if(this.var_2442 && this.var_2441 && this.var_2440)
            {
      ...
      public function createAvatarImage(param1:String, param2:String, param3:String = null, param4:IAvatarImageListener = null) : IAvatarImage
      {
         ...
         if(!this.var_1744)
         {
            this.var_1744 = new AvatarFigureContainer(this.const_2014);
         }
         this.var_218.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1744,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1667)
         {
