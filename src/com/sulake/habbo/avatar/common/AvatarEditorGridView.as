package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(this.var_17 != null)
         {
            this.var_648 = this.var_17.findChildByName("part_thumbs") as IItemGridWindow;
            this.var_528 = new Array();
            this.var_528.push(this.var_17.findChildByName("palette0") as IItemGridWindow);
            this.var_528.push(this.var_17.findChildByName("palette1") as IItemGridWindow);
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         for each(_loc2_ in _loc1_.parts)
         {
            if(_loc2_)
            {
               this.var_648.addGridItem(_loc2_.view);
      ...
      {
         var _loc3_:IWindow = this.var_648.getGridItemAt(param1);
         if(!_loc3_)
         {
            return;
         }
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_648.getGridItemIndex(param1.window);
