package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1331:String = "Default";
      
      private static const const_1330:int = 2;
      
      private static const const_1329:String = AvatarSetType.const_35;
      ...
      private var var_936:IActiveActionData;
      ...
      protected var var_1250:Boolean = false;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1329,const_1330);
         this.var_322 = new Array();
         this.var_936 = new ActiveActionData(AvatarAction.const_366);
         this.var_936.definition = this._structure.getActionDefinition(const_1331);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_569,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1846;
         if(param2 < AvatarDirectionAngle.const_1188)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_265.length == 1 && this.var_89 == this.var_2015)
         {
            return this.var_89 + this.var_512 + this.var_621 % 4;
         }
      ...
      {
         if(param3 != this.var_2624 || param2 != this.var_2625 || param1 != this.var_2623)
         {
            this.var_2624 = param3;
            this.var_2625 = param2;
            this.var_2623 = param1;
            this.var_1850 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1250 || this.var_45 == null || (this.var_45.width != _loc5_.width || this.var_45.height != _loc5_.height))
         {
            if(this.var_45 != null && !this.var_1250)
            {
               this.var_45.dispose();
            }
         ...
         if(this.var_534 != null)
         {
            if(this.var_534.paletteIsGrayscale)
            {
               ...
               this.var_45 = _loc13_;
               this.var_45.paletteMap(this.var_45,this.var_45.rect,new Point(0,0),this.var_534.reds,[],[]);
            }
            else
            {
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_322.push(new ActiveActionData(param1,param2,this.var_621));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_276 = this.var_936;
         this.var_276.definition = this.var_936.definition;
         this.resetBodyPartCache(this.var_936);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_512 = "";
         this.var_265 = this._structure.sortActions(this.var_322);
         if(this.var_265 == null)
         {
            this.var_742 = new Array(0,0,0);
            if(this.var_1445 != "")
            {
               _loc1_ = true;
               this.var_1445 = "";
         ...
         {
            this.var_742 = this._structure.getCanvasOffsets(this.var_265,this._scale,this.var_89);
            ...
            if(this.var_1445 != this.var_512)
            {
               _loc1_ = true;
               this.var_1445 = this.var_512;
            }
         }
         this.var_1439 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_265)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_937 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1846 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_284 || _loc1_.actionType == AvatarAction.const_240 || _loc1_.actionType == AvatarAction.const_336)
               {
                  this.var_937 = true;
               }
            }
