package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_1224:AvatarEditorHandler;
      ...
      private var var_977:IFigureData;
      ...
      private var var_1481:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_873 = FigureData.const_74;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_187)
         {
            ...
            _loc2_.loadAvatarData(const_1366,FigureData.const_74);
            _loc3_.loadAvatarData(const_1367,FigureData.FEMALE);
            this.var_97 = new Map();
            this.var_523 = new Map();
            this.var_97.add(AvatarEditorFigureCategory.const_729,new BodyModel(this));
            this.var_97.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_97.add(AvatarEditorFigureCategory.const_216,new TorsoModel(this));
            this.var_97.add(AvatarEditorFigureCategory.const_802,new LegsModel(this));
            ...
            this.var_523.add(AvatarEditorSideCategory.const_103,new WardrobeModel(this));
            this.var_523.add(AvatarEditorSideCategory.const_551,new ClubPromoModel(this));
            this.var_187 = true;
         }
      }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_977.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_977.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_273 == null)
            {
               this.var_273 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_63,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_273.addChild(this.var_17.window);
               if(param5)
               {
                  this.var_273.center();
               }
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_729);
         }
      ...
      {
         this.var_977 = this.var_522.getFigureData(AvatarType.const_123);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1224 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_641[this.var_873];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1481 != null)
         {
            ...
            this.var_1481.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1924;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1223 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1365)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1499.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1432)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1223 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1223 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_523.getValue(AvatarEditorSideCategory.const_103);
      }
