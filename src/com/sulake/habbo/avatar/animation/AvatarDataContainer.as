package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1857 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2642 = parseInt(_loc2_,16);
         this.var_2641 = parseInt(_loc3_,16);
         ...
         this.var_1881 = new ColorTransform(this.var_1880,this.var_1878,this.var_1879,this._alphaMultiplier);
         this.var_1192 = this.generatePaletteMapForGrayscale(this.var_2641,this.var_2642);
      }
      ...
      {
         return this.var_1192.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1192.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1192.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1192.getValue("alphas") as Array;
      }
