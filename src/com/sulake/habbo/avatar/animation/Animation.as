package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1793:AvatarDataContainer;
      
      private var var_1407:Array;
      
      private var var_1791:DirectionDataContainer;
      
      private var var_1792:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1558 = String(param2.@desc);
         }
         else
         {
            this.var_1558 = this._id;
         }
         ...
         {
            this.var_1793 = new AvatarDataContainer(param2.avatar[0]);
         }
         if(param2.hasOwnProperty("canvas"))
         {
            for each(_loc4_ in param2.canvas)
            {
               this.var_1407.push(new CanvasDataContainer(_loc4_));
            }
         }
         if(param2.hasOwnProperty("direction"))
         {
            this.var_1791 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            this.var_1792 = new ShadowDataContainer(param2.shadow[0]);
         }
         if(param2.hasOwnProperty("remove"))
         {
            for each(_loc5_ in param2.remove)
            {
               this.var_1406.push(String(_loc5_.@id));
            }
         }
         ...
         if(param2.hasOwnProperty("HabboUserDefinedRoomEventsCom_icon_action_png"))
         {
            this._overrideFrames = new Map();
            this.var_602 = new Map();
            for each(_loc7_ in param2.HabboUserDefinedRoomEventsCom_icon_action_png)
            {
               _loc8_ = _loc7_.@name;
               _loc9_ = _loc7_.@HabboUserDefinedRoomEventsCom_icon_action_png;
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc8_ in _loc7_.bodypart)
            {
               ...
               _loc10_ = new AnimationLayerData(param3,_loc8_,AnimationLayerData.const_774,_loc6_,_loc5_);
               _loc4_.push(_loc10_);
            }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         {
            if(_loc4_.type == AnimationLayerData.const_774)
            {
