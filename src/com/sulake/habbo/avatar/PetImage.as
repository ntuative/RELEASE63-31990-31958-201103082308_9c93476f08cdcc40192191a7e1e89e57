package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_569:AvatarFigureContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_569 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_569.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1438 = this.var_1203;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_51)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1438);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_569,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1438 < 3;
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_569,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_86)
               {
                  _loc17_ = 6;
         ...
         switch(param1)
         {
            case AvatarAction.const_377:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1617:
                  case AvatarAction.const_1143:
                  case AvatarAction.const_1130:
                  case AvatarAction.const_1613:
                  case AvatarAction.const_1502:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_936);
         this.getCache().resetBodyPartCache(this.var_936);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1437 = this._structure.sortActions(this.var_322);
         ...
         {
            this.var_742 = this._structure.getCanvasOffsets(this.var_1437,this._scale,this.var_89);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1437)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_284)
               {
                  this.var_937 = true;
               }
            }
