package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private const const_2018:int = 100;
      
      private const const_1450:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         this.var_946 = new Timer(this.const_2018,1);
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_430)
         {
            this.var_430.addEventListener(AssetLoaderEvent.const_27,this.onConfigurationComplete);
            this.var_430.addEventListener(AssetLoaderEvent.const_46,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_430)
         {
            this.var_430.removeEventListener(AssetLoaderEvent.const_27,this.onConfigurationComplete);
            this.var_430.removeEventListener(AssetLoaderEvent.const_46,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_948);
            if(this.var_1453.indexOf("?") > 0)
            {
               _loc2_ = this.var_1453 + "&retry=" + this.var_948;
            }
            else
            {
               _loc2_ = this.var_1453 + "?retry=" + this.var_948;
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1869)
         {
            this.var_1195.push([param1,param2]);
            return;
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_773.length > 0 && this.var_772.length < this.const_1450)
         {
