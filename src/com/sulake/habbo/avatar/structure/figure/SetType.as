package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class SetType implements ISetType
   {
      ...
      public function SetType(param1:XML)
      {
         ...
         this.var_2680 = parseInt(param1.@paletteid);
         this.var_626 = new Dictionary();
         this.var_626["F"] = new Dictionary();
         this.var_626["M"] = new Dictionary();
         this.var_626["F"][0] = Boolean(parseInt(param1.@mand_f_0));
         this.var_626["F"][1] = Boolean(parseInt(param1.@mand_f_1));
         this.var_626["M"][0] = Boolean(parseInt(param1.@mand_m_0));
         this.var_626["M"][1] = Boolean(parseInt(param1.@mand_m_1));
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this._partSets.method_1())
         {
            _loc1_.dispose();
         }
      ...
      {
         return this.var_626[param1.toUpperCase()][Math.min(param2,1)];
      }
