package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1869:int = "F".charCodeAt(0);
      
      public static const const_1777:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_873 = param1.gender;
         this.var_728 = param1.online;
         this.var_1531 = param1.followingAllowed && param1.online;
         this.var_569 = param1.figure;
         this.var_1757 = param1.motto;
         this.var_1726 = param1.lastAccess;
