package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         this.var_733.addEventListener(WindowKeyboardEvent.const_197,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_58.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_374,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
