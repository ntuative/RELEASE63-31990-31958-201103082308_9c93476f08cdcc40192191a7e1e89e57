package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1054:IAvatarRenderManager;
      
      private var var_734:ISessionDataManager;
      
      private var var_2448:FriendListLookAndFeel;
      
      private var var_414:FriendListTabs;
      
      private var var_17:FriendListView;
      
      private var var_1752:OpenedToWebPopup;
      
      private var var_2447:int;
      
      var var_97:FriendCategories;
      
      private var var_360:FriendRequests;
      
      private var var_1751:AvatarSearchResults;
      
      private var var_179:IHabboToolbar;
      
      private var var_964:IHabboNotifications;
      
      private var var_593:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2448 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_97 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1751 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1054)
         {
            this.var_1054.release(new IIDAvatarRenderManager());
            this.var_1054 = null;
         }
         if(this.var_964)
         {
            this.var_964.release(new IIDHabboNotifications());
            this.var_964 = null;
         }
         if(this.var_179)
         {
         ...
         if(this.var_734)
         {
            this.var_734.release(new IIDSessionDataManager());
            this.var_734 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1752 = new OpenedToWebPopup(this);
         }
         this.var_1752.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_360.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_293,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1054.createAvatarImage(param1,AvatarScaleType.const_86,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1054 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_964 = param2 as IHabboNotifications;
      ...
      {
         this.var_734 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_360 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_97.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_97.addCategory(new FriendCategory(FriendCategory.const_1019,this.getText("friendlist.friends")));
         this.var_97.addCategory(new FriendCategory(FriendCategory.const_358,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_97.addFriend(new Friend(_loc4_));
         }
         this.var_414 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_593)
         {
         ...
         this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_139,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_97.findCategory(FriendCategory.const_358);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this.var_17.openFriendList();
            _loc1_ = this.var_414.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_344));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_360.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_360.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_414.findTab(FriendListTab.const_100).method_4(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_360.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_414.findTab(FriendListTab.const_100);
         _loc4_.method_4(true);
         this.refreshToolBarIcon();
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1751.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_414.findTab(FriendListTab.const_100);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_734 || !this.var_360)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_734.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_43))
         {
            _loc2_ = this.var_360.vipLimit;
         }
         else if(this.var_734.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_41))
         {
            _loc2_ = this.var_360.clubLimit;
         }
         if(_loc2_ > this.var_360.limit)
         {
            this.var_360.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_166) as IBitmapWrapperWindow;
