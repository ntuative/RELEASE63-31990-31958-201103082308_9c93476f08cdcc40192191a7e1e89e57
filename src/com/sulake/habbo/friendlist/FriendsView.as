package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_1943:String = "bg";
      ...
      private var var_2107:IContainerButtonWindow;
      ...
      {
         this.var_2106 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2109 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2107 = this.initButton("room_invite",this.onInviteButtonClick,param1);
      ...
      {
         this._friendList.tabs.findTab(FriendListTab.const_95).method_4(true);
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2106,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2109,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2107,this.isEnableInviteButton(_loc1_));
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_276)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_276 && _loc4_.online)
            {
