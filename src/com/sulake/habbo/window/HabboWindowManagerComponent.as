package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1313:uint = 1;
      ...
      private var var_928:IWindowRenderer;
      
      private var var_929:ISkinContainer;
      
      private var var_370:Array;
      
      private var var_1428:IEventDispatcher;
      
      private var var_1165:Boolean = false;
      
      private var var_1829:ProfilerOutput;
      
      private var var_1429:ProfilerAgentTask;
      
      private var var_1430:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_929 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_928 = new WindowRenderer(this.var_929);
         this.var_201 = new Array(const_417);
         ...
         {
            this.var_201[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_928,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_273 = this.var_201[const_1313];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1829)
            {
               this.var_1829 = new ProfilerOutput(context,this,this.var_928);
            }
            this.var_1829.profiler = _loc3_;
            this.var_1429 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1429);
            this.var_1430 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1430);
            this.var_1165 = true;
         }
      }
      ...
      {
         var _loc3_:Dictionary = this.var_370[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_370[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_929.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_201[param1].getDesktopWindow().getChildAt(this.var_273.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1428.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_417 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1428.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         this.var_1428.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1575,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1609,param2.name + ": " + param2.toString());
            }
         }
      }
