package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1820 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1158 = this.var_1820.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1158)
         {
            this.var_1158.procedure = this.onButtonClick;
         }
         this.var_1159 = this.var_1820.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1159)
         {
      ...
      {
         if(this.var_263 >= this.var_78.length - 1)
         {
         ...
         if(this.var_263 <= 0)
         {
            this.var_1158.disable();
         }
         else
         {
            this.var_1158.enable();
         }
      }
      ...
      {
         ++this.var_263;
         this.var_263 = Math.min(this.var_263,this.var_78.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_78[this.var_263][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_78[this.var_263][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_78[this.var_263][1]).value;
