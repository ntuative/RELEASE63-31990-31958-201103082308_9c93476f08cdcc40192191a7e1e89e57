package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1467:int = 2;
      ...
      private var var_1895:TriggerConfs;
      
      private var var_1893:ActionTypes;
      
      private var var_1894:ConditionTypes;
      ...
      {
         this.var_1895 = new TriggerConfs();
         this.var_1893 = new ActionTypes();
         this.var_1894 = new ConditionTypes();
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1207 = new SliderWindowController(this.var_83,IWindowContainer(this.find(this.var_52,"delay_slider_container")),this.var_83.assets,0,20,1);
         this.var_1207.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1207.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_783.hideAll(this.var_271);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_783.showAll(this.var_271);
         if(this.var_36 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_36);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1207.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1207.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1467) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1467 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1895);
         this.refreshConfigureElement(this.var_1893);
         this.refreshConfigureElement(this.var_1894);
