package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_917);
         }
      ...
      {
         return int(this.var_1694 * (Number(param1 - this._minValue) / (this.var_1144 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1694 * (this.var_1144 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_918)
         {
            if(param1.type == WindowMouseEvent.const_61 || param1.type == WindowMouseEvent.const_201)
            {
               this.var_918 = false;
            }
         }
         if(!this.var_918 || param1.type != WindowEvent.const_407)
         {
            return;
         }
         if(this.var_605 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_605) * this.var_605;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_605 != 0)
            {
               _loc3_ = this.var_917 + this.var_605;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_708 != null)
            {
               ...
               this.var_1694 = _loc1_.width - _loc2_.width;
            }
         }
