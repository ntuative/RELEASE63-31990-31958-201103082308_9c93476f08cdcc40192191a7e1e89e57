package com.sulake.habbo.sound.music
{
   ...
   public class RoomItemPlayListController implements IPlayListController, IDisposable
   {
      ...
      private var var_580:HabboMusicController;
      ...
      public function RoomItemPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_821,this.onSongFinishedPlayingEvent);
         this.var_83.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_638,this.onSoundMachinePlayEvent);
         this.var_83.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_843,this.onSoundMachineStopEvent);
         this.var_83.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_767,this.onJukeboxStopEvent);
         this.var_83.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_449,this.onDisposeEvent);
      }
      ...
      {
         return HabboMusicPrioritiesEnum.const_1055;
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_821,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_83)
            {
               this.var_83.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_638,this.onSoundMachinePlayEvent);
               this.var_83.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_843,this.onSoundMachineStopEvent);
               this.var_83.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_767,this.onJukeboxStopEvent);
               this.var_83.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_449,this.onDisposeEvent);
               this.var_83 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_488);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_580.requestSongInfo(_loc2_.id);
            }
         }
      }
      ...
      {
         this.var_580.stop(HabboMusicPrioritiesEnum.const_1055);
         this.var_488 = -1;
         this.var_714 = false;
      }
      ...
      {
         var _loc2_:IHabboSound = this.var_580.getSongObject(this.var_488);
         if(_loc2_ != null)
         {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_580.playSong(param1,this.priority,_loc3_))
         {
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_.current >= 0)
         {
            this.var_580.playSong(_loc3_.current,this.priority,_loc3_.syncCount / 1000);
         }
         if(_loc3_.next >= 0)
         {
            this.var_580.requestSongInfo(_loc3_.next);
         }
         this.var_714 = true;
