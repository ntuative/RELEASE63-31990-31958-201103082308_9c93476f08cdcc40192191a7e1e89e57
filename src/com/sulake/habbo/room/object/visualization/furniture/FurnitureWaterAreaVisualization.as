package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1251:String = "shore";
      ...
      {
         if(this.var_2207 == param1 && this.var_2206 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,_direction,_loc2_) == const_1251)
            {
               this.var_1639 = _loc2_;
               this.var_2207 = param1;
               this.var_2206 = _direction;
               return this.var_1639;
            }
            _loc2_--;
         }
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1641 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_409.length)
         {
            if(this.var_409[_loc5_] == true)
            {
               this.var_1641 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_563[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_563[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_480 == 0 || this.var_562 == 0)
         {
            ...
            this.var_480 = _loc2_.getNumber(RoomObjectVariableEnum.const_285);
            this.var_562 = _loc2_.getNumber(RoomObjectVariableEnum.const_382);
         }
         this.var_409 = [];
         this.var_563 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_480 * 2 + this.var_562 * 2)
         {
            this.var_409.push(false);
            this.var_563.push(ShoreMaskCreatorUtility.const_77);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_71,getSize(param3),this.var_409,this.var_563,assetCollection);
      }
