package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1586:String = "cone";
      
      public static const const_1604:String = "plane";
      
      public static const const_1404:String = "sphere";
      ...
      public function reset() : void
      {
         ...
         this.var_886 = 0;
         this.var_890 = false;
         this.init(0,0,0,this._direction,this.var_2342,this.var_885,this.var_2341,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1086.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_890 = true;
         if(this.var_886 < this.var_1356)
         {
            if(this.age > 1)
            {
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1086.length);
         return this.var_1086[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_886 < this.var_1356)
         {
            if(this.age % this.var_2338 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_886 < this.var_1356)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_251) * this.x - (1 - this.var_251) * this.lastX;
            this.y = (2 - this.var_251) * this.y - (1 - this.var_251) * this.lastY + this.var_1701 * this.var_885 * this.var_885;
            this.z = (2 - this.var_251) * this.z - (1 - this.var_251) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         ...
         for each(_loc2_ in this.var_355)
         {
            ...
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_251) * _loc2_.x - (1 - this.var_251) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_251) * _loc2_.y - (1 - this.var_251) * _loc2_.lastY + this.var_1701 * this.var_885 * this.var_885;
            _loc2_.z = (2 - this.var_251) * _loc2_.z - (1 - this.var_251) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_355.splice(this.var_355.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
