package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_548 != spriteCount)
         {
            createSprites(this.var_548);
         }
         var _loc4_:Boolean = false;
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_445 != _loc3_.getUpdateID() || param1 != var_185 || param2 != this.var_2765)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(var_167 != _loc3_.getUpdateID())
         {
            this.var_2766 = _loc3_.getNumber(RoomObjectVariableEnum.const_266);
            ...
            this.var_1240 = _loc3_.getString(RoomObjectVariableEnum.const_379);
      ...
      {
         if(this.var_2165 != param2 || this.var_2163 != param1)
         {
            this.var_851 = [];
            this.var_852 = [];
            this.var_687 = [];
            ...
            this.var_2164 = this.getSize(param1);
            this.var_548 = this._data.getLayerCount(param1) + this.getAdditionalSpriteCount();
            this.var_1607 = this.var_548 - this.getAdditionalSpriteCount();
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_537.length)
         {
            return "";
         }
         var _loc3_:String = this.var_851[param2];
         var _loc4_:Boolean = this.var_852[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2164;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1607)
            {
               _loc6_ = FurnitureVisualizationData.const_537[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_851[param2] = _loc3_;
            this.var_852[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_685[param3] != null && !this.var_1608)
         {
      ...
      {
         if(this.var_689[param2] != null)
         {
            return this.var_689[param2];
         }
         if(this._data == null)
         {
