package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1930:int = 16777216;
      ...
      private var var_1538:int = 16777216;
      
      private var var_2786:int = 69069;
      ...
      public static function method_1(param1:int, param2:int, param3:int) : Array
      {
         if(_randomizer == null)
         {
            _randomizer = new Randomizer();
      ...
      {
         var _loc1_:int = this.var_2786 * this.var_1539 + this.var_2785;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1538;
         this.var_1539 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1538 * param2);
      }
   }
}
