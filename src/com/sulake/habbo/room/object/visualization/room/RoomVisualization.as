package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1594:int = 13421772;
      
      private static const const_931:int = 16777215;
      
      private static const const_930:int = 13421772;
      
      private static const const_929:int = 10066329;
      
      private static const const_932:int = 10066329;
      
      public static const const_1588:int = 16777215;
      
      public static const const_1472:int = 13421772;
      
      public static const const_1659:int = 10066329;
      ...
      private var var_2257:int = 255;
      
      private var var_2259:int = 255;
      
      private var var_2254:int = 255;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_293["null"] = false;
         this.var_293["null"] = true;
         this.var_293["null"] = true;
         this.var_293["null"] = true;
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1087);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1124);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_280)
            {
               ...
               {
                  _loc13_.color = const_1472;
               }
               else
               {
                  _loc13_.color = const_1659;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1431)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_124,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
            ...
            while(_loc9_ < this.var_346.length)
            {
               ...
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_94)
               {
                  if(this.var_1665)
                  {
                     ...
                     _loc14_ = uint((_loc13_ & 255) * this.var_2254 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2259 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2257 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1632)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1363 || _loc3_.y != this.var_2256 || _loc3_.z != this.var_2260 || param1.scale != this.var_2258))
            {
               this.var_1363 = _loc3_.x;
               this.var_2256 = _loc3_.y;
               this.var_2260 = _loc3_.z;
               this.var_2258 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_167 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1173);
            if(_loc3_ != this.var_2255)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2255 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_728));
            if(_loc4_ != this.var_1066)
            {
               this.var_1066 = _loc4_;
               this.var_2254 = this.var_1066 & 255;
               this.var_2259 = this.var_1066 >> 8 & 255;
               this.var_2257 = this.var_1066 >> 16 & 255;
               _loc2_ = true;
            }
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_167 != param1.getUpdateID())
         {
            ...
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_725);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_846);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_726));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_636));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_852));
      ...
      {
         if(param1 != this.var_293["null"] || param2 != this.var_293["null"] || param3 != this.var_293["null"])
         {
            this.var_293["null"] = param1;
            this.var_293["null"] = param2;
            this.var_293["null"] = param3;
            this.var_346 = [];
            this.var_568 = [];
         }
      }
         ...
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_293[_loc12_.type]))
                  {
         ...
         while(_loc8_ < this.var_483.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_125.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_124 || _loc3_.type == RoomPlane.const_94)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_124 || _loc3_.type == RoomPlane.const_94 && _loc12_ == RoomPlaneBitmapMaskData.const_265)
                              {
