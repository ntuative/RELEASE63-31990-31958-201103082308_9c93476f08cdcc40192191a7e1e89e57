package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1090:Vector3d = null;
      ...
      private var var_924:IPlaneRasterizer = null;
      
      private var var_759:PlaneMaskManager = null;
      ...
      private var var_423:PlaneBitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_1090 = new Vector3d();
         this.var_1090.assign(param1);
         ...
         this.var_583 = Vector3d.crossProduct(this.var_296,this.var_295);
         ...
         this.var_2577 = param9;
         this.var_2576 = param10;
         this.var_2575 = param11;
         this.var_2578 = param12;
         this.var_923 = param6;
      }
      ...
      {
         return this._isVisible && this.var_749;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_924.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_423;
         if(_loc3_ == null)
         {
         ...
         if(this.var_749 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_368))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_924 != null)
            {
               _loc3_ = this.var_924.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1822,this.var_2577,this.var_2576,this.var_2575,this.var_2578,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(!geometryChanged || !this.var_749)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            originPos = geometry.getScreenPosition(this.var_1090);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_149.z - originZ,this.var_111.z - originZ,this.var_86.z - originZ,this.var_112.z - originZ);
            if(this._type == const_94)
            {
               relativeDepth += 0.02;
            }
            this.var_2366 = relativeDepth;
         ...
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2574);
      ...
      private function updateCorners(param1:IRoomGeometry) : void
      {
         ...
         this.var_111.assign(param1.getScreenPosition(Vector3d.sum(this.var_79,this.var_295)));
         this.var_86.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_79,this.var_296),this.var_295)));
         this.var_112.assign(param1.getScreenPosition(Vector3d.sum(this.var_79,this.var_296)));
         this._offset = param1.getScreenPoint(this.var_1090);
         ...
         var _loc2_:Number = Math.min(this.var_149.x,this.var_111.x,this.var_86.x,this.var_112.x);
         var _loc3_:Number = Math.max(this.var_149.x,this.var_111.x,this.var_86.x,this.var_112.x);
         var _loc4_:Number = Math.min(this.var_149.y,this.var_111.y,this.var_86.y,this.var_112.y);
         var _loc5_:Number = Math.max(this.var_149.y,this.var_111.y,this.var_86.y,this.var_112.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_149 == null || this.var_111 == null || this.var_86 == null || this.var_112 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         var _loc3_:Number = this.var_112.x - this.var_86.x;
         var _loc4_:Number = this.var_112.y - this.var_86.y;
         var _loc5_:Number = this.var_111.x - this.var_86.x;
         var _loc6_:Number = this.var_111.y - this.var_86.y;
         if(this._type == const_124 || this._type == const_94)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_124 || this._type == const_94))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_264.length == this.var_925.length)
         {
            while(_loc1_ < this.var_264.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_925[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_369.length > this.var_1424.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_923 || this.var_264.length == 0 && this.var_369.length == 0 && !this.var_368 || this.var_759 == null)
         {
            return;
         }
         ...
         if(this.var_368)
         {
            ...
            while(_loc5_ < this.var_264.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_71.width - this.var_71.width * _loc3_.leftSideLoc / this.var_296.length;
                  _loc11_ = this.var_71.height - this.var_71.height * _loc3_.rightSideLoc / this.var_295.length;
                  _loc12_ = _loc3_.type;
                  this.var_759.updateMask(this.var_71,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_925.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_369.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_71.width - this.var_71.width * _loc4_.leftSideLoc / this.var_296.length;
                  _loc11_ = this.var_71.height - this.var_71.height * _loc4_.rightSideLoc / this.var_295.length;
                  _loc13_ = this.var_71.width * _loc4_.leftSideLength / this.var_296.length;
                  _loc14_ = this.var_71.height * _loc4_.rightSideLength / this.var_295.length;
                  this.var_71.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1424.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_368 = false;
