package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_943:int = 1000;
      
      private static const const_1282:String = "pet_experience_bubble_png";
      ...
      private var var_282:AnimatedPetVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_282 = param1 as AnimatedPetVisualizationData;
         var _loc2_:* = null;
         if(this.var_282.commonAssets != null)
         {
            _loc3_ = this.var_282.commonAssets.getAssetByName(const_1282) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_167)
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_335);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_219);
            this.validateActions(_loc4_,_loc5_);
            this._isSleeping = _loc3_.getNumber(RoomObjectVariableEnum.const_341) > 0;
            this.var_1712 = _loc3_.getNumber(RoomObjectVariableEnum.const_294);
            this.var_1393 = _loc3_.getNumber(RoomObjectVariableEnum.const_730);
            this.var_2056 = _loc3_.getNumber(RoomObjectVariableEnum.const_845);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
            if(_loc6_ != this.var_1762)
            {
               this.var_1762 = _loc6_;
               this.var_2476 = this.var_1762.toString();
            }
            var_167 = _loc3_.getUpdateID();
            return true;
         }
         return false;
      }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this._experienceData != null)
         {
            ...
            if(this.var_1393 > 0)
            {
               _loc2_ = param1 - this.var_1393;
               if(_loc2_ < const_943)
               {
                  this._experienceData.alpha = int(Math.sin(_loc2_ / const_943 * 0) * 255);
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         {
            this.var_252 = param1;
            _loc3_ = this.var_282.getAnimationForPosture(var_185,param1);
            this.setAnimationForIndex(const_1283,_loc3_);
         }
         if(param2 != this.var_1364)
         {
            this.var_1364 = param2;
            _loc3_ = this.var_282.getAnimationForGesture(var_185,param2);
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2476);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_605)
         {
            ...
            {
               if(_data == null || param2 >= FurnitureVisualizationData.const_537.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_537[param2];
               if(_loc4_ == 1)
               {
