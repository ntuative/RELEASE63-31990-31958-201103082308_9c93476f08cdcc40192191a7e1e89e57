package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_584:PetVisualizationData = null;
      ...
      private const const_2015:int = 3;
      ...
      private const const_1269:int = 3;
      ...
      {
         this.var_584 = param1 as PetVisualizationData;
         createSprites(this.const_1269);
         var _loc2_:BitmapData = (this.var_584.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this._isSleeping = param1.getNumber(RoomObjectVariableEnum.const_341) > 0;
            this.var_1364 = param1.getString(RoomObjectVariableEnum.const_219);
            this.var_252 = param1.getString(RoomObjectVariableEnum.const_335);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_904);
            this.var_1712 = param1.getNumber(RoomObjectVariableEnum.const_294);
            this.var_1393 = param1.getNumber(RoomObjectVariableEnum.const_730);
            this.var_2056 = param1.getNumber(RoomObjectVariableEnum.const_845);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_190);
            if(this.var_569 != _loc3_)
            {
               this.var_569 = _loc3_;
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_445 != param1.getUpdateID() || this.var_1632 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1712;
            if(isNaN(this.var_1712))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_1715 || param3)
            {
            ...
            if(_loc5_ != this.var_1718 || param3)
            {
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_584.getAvatar(this.var_569,param1,this);
            if(_loc3_ != null)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc9_ || _loc6_ != var_185 || this.var_57 == null)
         {
            if(_loc6_ != var_185)
            {
               var_185 = _loc6_;
         ...
         var _loc11_:Boolean = this.var_937 || this.var_1137 > 0 || this.var_1778;
         this._experienceData.alpha = 0;
         if(this.var_1393 > 0)
         {
            _loc12_ = param2 - this.var_1393;
            if(_loc12_ < AvatarAction.const_943)
            {
               this._experienceData.alpha = int(Math.sin(_loc12_ / 0 * 0) * 255);
               this._experienceData.setExperience(this.var_2056);
               this.var_1137 = this.const_2015;
            }
            else
            {
               this.var_1393 = 0;
         ...
         if(_loc10_ || _loc11_)
         {
            ...
            if(_loc13_)
            {
               _loc18_ = this.var_57.getImage(AvatarSetType.const_35,false);
               if(_loc18_ != null)
               {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1364 != null && this.var_1364 != "")
         {
            param1.appendAction(AvatarAction.const_278,this.var_1364);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1269;
