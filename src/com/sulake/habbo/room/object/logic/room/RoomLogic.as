package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1530:int = 255;
      
      private var var_1266:uint = 16777215;
      
      private var var_1527:int = 255;
      
      private var var_1012:uint = 16777215;
      
      private var var_1528:int = 255;
      
      private var var_1013:int = 0;
      
      private var var_1529:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1087,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_728,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_726,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_636,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_852,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1013)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1530;
            if(_loc2_ - this.var_1013 >= this.var_1529)
            {
               _loc3_ = this.var_1012;
               _loc4_ = this.var_1528;
               this.var_1013 = 0;
            }
            else
            {
               _loc7_ = this.var_1266 >> 16 & 255;
               _loc8_ = this.var_1266 >> 8 & 255;
               _loc9_ = this.var_1266 & 255;
               _loc10_ = this.var_1012 >> 16 & 255;
               _loc11_ = this.var_1012 >> 8 & 255;
               _loc12_ = this.var_1012 & 255;
               _loc13_ = (_loc2_ - this.var_1013) / this.var_1529;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1527 + (this.var_1528 - this.var_1527) * _loc13_;
               this._color = _loc3_;
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_655:
               param2.setString(RoomObjectVariableEnum.const_725,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_881:
               param2.setString(RoomObjectVariableEnum.const_773,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_890:
               param2.setString(RoomObjectVariableEnum.const_846,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1173,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1222:
               param2.setNumber(RoomObjectVariableEnum.const_726,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1054:
               param2.setNumber(RoomObjectVariableEnum.const_636,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_852,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1266 = this._color;
         this.var_1527 = this.var_1530;
         this.var_1012 = _loc3_;
         this.var_1528 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_488,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1578,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1654,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1416,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_488,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_161 || _loc13_ == RoomPlaneData.const_280)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
