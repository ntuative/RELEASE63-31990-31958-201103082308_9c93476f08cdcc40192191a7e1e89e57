package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2842:IWindowContainer;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_505 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_505.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_505 == null ? 0 : int(this.var_505.selection);
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 3)
         {
            return Tabs.const_810;
         }
         if(param1 == 4)
         {
            return Tabs.const_894;
         }
