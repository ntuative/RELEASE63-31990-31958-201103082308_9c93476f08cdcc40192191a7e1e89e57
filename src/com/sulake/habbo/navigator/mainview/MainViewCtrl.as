package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_1267:int = 4;
      ...
      private var var_877:PopularTagsListCtrl;
      
      private var var_876:GuestRoomListCtrl;
      
      private var var_1076:OfficialRoomListCtrl;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_877 = new PopularTagsListCtrl(this._navigator);
         this.var_876 = new GuestRoomListCtrl(this._navigator);
         this.var_1076 = new OfficialRoomListCtrl(this._navigator);
      ...
      private function prepare() : void
      {
         ...
         this.var_239 = ITabContextWindow(this.var_16.findChildByName("tab_context"));
         if(!this.var_239)
         {
         ...
         this.var_250 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1637,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_178,["custom_content","list_content"],this.var_213.y,8);
         this.var_195.height = this.var_195.height + _loc1_ - this.var_195.y - this.var_250.height + this.var_2293;
         Util.moveChildrenToColumn(this.var_178,["list_content","custom_footer"],this.var_195.y,0);
         this.var_2293 = this.var_250.height;
      ...
      {
         this.refreshList(param1,param2,this.var_877,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1076,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_578 == const_936)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_195.blend - _loc2_));
            this.var_195.blend = _loc3_;
            this.var_213.blend = !!this.var_1075 ? Number(_loc3_) : Number(1);
            this.var_250.blend = !!this.var_1075 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_578 = const_600;
            }
         }
         else if(this.var_578 == const_600)
         {
            ...
            {
               this.var_578 = const_935;
            }
         }
         else if(this.var_578 == const_935)
         {
            this.refresh();
            this.var_578 = const_1267;
         }
         else
         {
      ...
      {
         this.refreshScrollbar(this.var_877);
