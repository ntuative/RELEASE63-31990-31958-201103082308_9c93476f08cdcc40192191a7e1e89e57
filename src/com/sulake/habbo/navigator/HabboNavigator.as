package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_541:RoomInfoViewCtrl;
      
      private var var_1014:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_414:Tabs;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_281 = new MainViewCtrl(this);
         this.var_541 = new RoomInfoViewCtrl(this);
         this.var_1014 = new RoomCreateViewCtrl(this);
         this.var_2026 = new RoomThumbnailRenderer(this);
         this.var_895 = new GuestRoomPasswordInput(this);
         this.var_292 = new GuestRoomDoorbell(this);
         this.var_414 = new Tabs(this);
         this.var_1015 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_293,HabboWindowStyle.const_42,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_541.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_139,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_139,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_281.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_281.startSearch(Tabs.const_215,Tabs.const_376,param1);
         this.var_281.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_281.startSearch(Tabs.const_277,Tabs.const_233);
         this.var_414.getTab(Tabs.const_277).tabPageDecorator.tabSelected();
      }
