package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_677:TextFieldManager;
      ...
      private var var_2119:IButtonWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_1586.visible = true;
         this.var_2120.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_677.setText(param1.eventDescription);
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_677.getText();
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_677.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1586 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2120 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1587 = ITextWindow(this.find("create_caption"));
            this.var_1588 = ITextWindow(this.find("edit_caption"));
            this.var_1301 = IButtonWindow(this.find("create_button"));
            this.var_1303 = IButtonWindow(this.find("edit_button"));
            this.var_2119 = IButtonWindow(this.find("cancel_button"));
            this.var_1302 = IButtonWindow(this.find("end_button"));
            this.var_841 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1301,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1303,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1302,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2119,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_677 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
