package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailEditorModel
   {
      ...
      private var var_194:RoomThumbnailObjectData;
      ...
      private function removeSelected() : void
      {
         ...
         var _loc2_:int = Util.remove(_loc1_,this.var_194);
         this.var_194 = null;
         if(_loc1_.length > 0)
         {
            this.var_194 = _loc1_[Math.min(_loc2_,_loc1_.length - 1)];
         }
      }
      ...
      {
         this.var_194 = this.findByPos(param1);
         if(this.var_194 == null)
         {
      ...
      public function setImg(param1:int) : void
      {
         ...
         if(this.var_567 == const_34)
         {
            if(this.var_194 == null)
            {
               return;
            }
            this.var_194.imgId = param1;
         }
      }
      ...
      public function getImgId() : int
      {
         ...
         return this.var_194 == null ? -1 : int(this.var_194.imgId);
      }
      ...
      {
         this._data = param1;
         this.var_567 = const_38;
         if(this._data.objects.length > 0)
         {
            this.var_194 = this._data.objects[0];
         }
         else
         {
            this.var_194 = null;
