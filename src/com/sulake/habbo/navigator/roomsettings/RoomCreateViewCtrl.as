package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1157:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_613 = new Timer(100);
         this.var_613.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_43,540,"t"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_43,512,"w"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_43,396,"x"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_43,440,"y"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_43,456,"z"));
         this.var_44.push(new RoomLayout(HabboClubLevelEnum.const_43,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_613)
         {
            this.var_613.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_613.reset();
            this.var_613 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1157.view.findChildByName("select_arrow"));
      ...
      private function prepare() : void
      {
         ...
         this.var_1156 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_178.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1156.goBackToInitialState();
         this.var_1156.input.textBackgroundColor = 4294967295;
         this.var_1157 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      {
         return Boolean(this.var_1156.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1156.getText();
         var _loc3_:String = "model_" + this.var_1157.name;
