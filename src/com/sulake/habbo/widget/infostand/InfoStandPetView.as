package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1991:int = 152;
      
      private const const_1984:int = 16;
      
      private const const_1255:int = 4;
      
      private const const_1987:uint = 14342874;
      
      private const const_1986:uint = 3815994;
      
      private const const_1994:uint = 2085362;
      
      private const const_1985:uint = 39616;
      
      private const const_1989:uint = 10513106;
      
      private const const_1992:uint = 8734654;
      
      private const const_1988:uint = 9094430;
      
      private const const_1993:uint = 6200576;
      
      private const const_1983:String = "happiness";
      
      private const const_1990:String = "experience";
      
      private const const_1995:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_193 == null || this.var_67 == null)
         {
            return;
         }
         ...
         this.var_193.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_193.width,this.var_67.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_193.width < this.var_67.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1983,param1.nutrition,param1.nutritionMax,this.const_1985,this.const_1994);
         this.updateStateElement(this.const_1990,param1.experience,param1.experienceMax,this.const_1992,this.const_1989);
         this.updateStateElement(this.const_1995,param1.energy,param1.energyMax,this.const_1993,this.const_1988);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_1991,this.const_1984,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_1987);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_1986);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1255,_loc7_.width - 2,_loc7_.height - 2 - this.const_1255);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1255);
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_53 = this.var_193.findChildByName("infostand_element_list") as IItemListWindow;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_192 && this.var_192.getPetId() == this.var_455)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_502,this._widget.petData.ownerId);
