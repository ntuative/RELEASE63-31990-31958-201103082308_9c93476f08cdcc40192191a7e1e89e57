package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1697:String = "infostand_furni_view";
      
      private const const_1696:String = "infostand_pet_view";
      
      private const const_1695:String = "infostand_bot_view";
      ...
      private var var_588:InfostandFurniData;
      ...
      private const const_2000:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1073 = new InfoStandFurniView(this,this.const_1697,this._catalog);
         this.var_126 = new InfoStandUserView(this,this.const_1694);
         this.var_353 = new InfoStandPetView(this,this.const_1696,this._catalog);
         this.var_412 = new InfoStandBotView(this,this.const_1695);
         this.var_1351 = new InfostandUserData();
         this.var_588 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_147 = new Timer(this.const_2000);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_298,this.onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_671,this.onUserGivableBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_678,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_298,this.onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_671,this.onUserGivableBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_678,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_394,this.var_353.getCurrentPetId()));
      }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1697);
         if(this.var_147)
         {
            this.var_147.stop();
         }
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1696);
         if(this.var_147)
         {
            this.var_147.start();
         }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_126.setTags(param1.tags,this.var_2272);
         }
      }
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_156:
               _loc2_ = param1.id == this.var_588.id;
               break;
