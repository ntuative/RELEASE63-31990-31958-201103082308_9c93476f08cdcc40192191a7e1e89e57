package com.sulake.habbo.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      {
         this.var_2111 = param1.balance;
         if(this.var_17)
         {
            this.var_17.findChildByName("credits").caption = this.var_2111.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_2110 = param1.balance;
         if(this.var_17)
         {
            this.var_17.findChildByName("pixels").caption = this.var_2110.toString();
         }
      }
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1090));
      }
   }
}
