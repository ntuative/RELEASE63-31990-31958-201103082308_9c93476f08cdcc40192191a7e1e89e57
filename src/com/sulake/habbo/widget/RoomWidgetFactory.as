package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2811:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2811 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_355:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_78,this.var_151,this.var_2537++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_78,this);
               break;
            case RoomWidgetEnum.include:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_78,this.var_151,this._catalog);
               break;
            case RoomWidgetEnum.const_460:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_78,events,this.var_151);
               break;
            ...
            case RoomWidgetEnum.const_571:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_78,this.var_151,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_548:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_78,this.var_151);
               break;
            case RoomWidgetEnum.const_645:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_78,this.var_151);
               break;
            case RoomWidgetEnum.const_114:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_78,this.var_151);
               break;
            ...
            case RoomWidgetEnum.const_559:
               _loc2_ = new WelcomeGiftWidget(this._windowManager,assets,this.var_78);
         }
         return _loc2_;
      }
   }
