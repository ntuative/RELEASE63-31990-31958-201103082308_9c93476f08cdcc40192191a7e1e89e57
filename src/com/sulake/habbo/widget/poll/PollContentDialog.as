package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1187;
         if(this.var_1187 < this.var_941.length)
         {
            _loc1_ = this.var_941[this.var_1187] as Dictionary;
            if(!_loc1_)
            {
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_428)
         {
            ...
            this.var_428 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_428.center();
            this.var_428.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_941[this.var_1187] as Dictionary;
