package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_340,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_340,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomWidgetPetPackageUpdateEvent.const_432:
               ...
               break;
            case RoomWidgetPetPackageUpdateEvent.const_340:
      ...
      private function showInterface() : void
      {
         ...
         this._window.x = const_1233;
         this._window.y = const_1232;
      ...
      {
         var _loc2_:* = null;
         if(this.var_634 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc2_ = new Point((_loc1_.width - this.var_634.width) / 2,(_loc1_.height - this.var_634.height) / 2);
            _loc1_.bitmap.copyPixels(this.var_634,this.var_634.rect,_loc2_);
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1214 || this.var_378 == -1)
         {
            return;
         }
         ...
         {
            this.var_1214 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_653,this.var_378,name);
