package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_63,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1233,const_1232,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1486 = _loc2_.light;
         if(this.var_440 != null)
         {
            this.var_440.setValue(this.var_1486);
         }
         this.var_513 = this.colors.indexOf(_loc2_.color);
         if(this.var_644 != null)
         {
            this.var_644.setSelectedColorIndex(this.var_513);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1485 = XML(_loc1_.content);
         return this.var_1485;
      }
