package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1705:int = 0;
      ...
      private const const_1703:int = 4;
      
      private const const_2008:int = 0;
      
      private const const_2004:int = 1;
      
      private const const_2006:int = 2;
      
      private const const_2012:int = 3;
      
      private const const_2010:int = 4;
      
      private const const_2011:int = 5;
      
      private const const_1708:String = "deco_img";
      
      private const const_1707:String = "dialog_bg";
      
      private const const_2007:String = "%campaign%_dialog_bg.png";
      
      private const const_332:String = "%campaign%_gift_package.png";
      
      private const const_2005:String = "%campaign%_gift_content.png";
      
      private const const_2009:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1371 = this.var_151.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1371 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1370.length)
         {
            _loc2_ = this.var_1370.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_151 = null;
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_649:
               ...
               this._shareId = null;
               this.var_1372 = param1.itemCategory;
               break;
         ...
         if(this._window && (this.var_1373 != _loc2_ || _loc3_ != this.var_174))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1373)
            {
               ...
               case this.const_1709:
                  if(this.var_384 == this.const_2008)
                  {
                  ...
                  else if(this.var_384 == this.const_2004)
                  {
                  ...
                  else if(this.var_384 == this.const_2006)
                  {
                  ...
                  else if(this.var_384 == this.const_2012)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_384 == this.const_2010)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_174,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_384 == this.const_2011)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2007.replace("%campaign%",this.var_174);
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_884);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1372 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1372 == 1 ? "null" : InventoryCategory.const_126);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_699,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1370.push(new ImageDownloader(this,_assets,this.var_174,this.var_1371,param1,param2));
            return;
         }
