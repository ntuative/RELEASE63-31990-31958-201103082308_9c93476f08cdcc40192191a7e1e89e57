package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_984:String = "welcome_gift_email_unverified";
      
      private const const_1726:String = "welcome_gift_email_verified";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1491)
         {
            this.setViewState(this.const_1726);
         }
         else
         {
            this.setViewState(this.const_984);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_984:
               ...
               this.var_17.findChildByName("email").caption = this.var_1230;
               break;
      ...
      {
         this.setViewState(!!this.var_1491 ? this.const_1726 : this.const_984);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1230 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1230));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_121,this.updateEventHandler);
         param1.addEventListener(RoomWidgetEmailUpdateEvent.const_515,this.emailChangeHandler);
         param1.addEventListener(RoomWidgetEmailUpdateEvent.const_531,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_121,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetEmailUpdateEvent.const_515,this.emailChangeHandler);
         param1.removeEventListener(RoomWidgetEmailUpdateEvent.const_531,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_121:
               this.var_1230 = param1.email;
               this.var_1491 = param1.isVerified;
               this.var_2454 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetEmailUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetEmailUpdateEvent.const_515:
               this.setViewState(this.const_984);
               break;
            case RoomWidgetEmailUpdateEvent.const_531:
