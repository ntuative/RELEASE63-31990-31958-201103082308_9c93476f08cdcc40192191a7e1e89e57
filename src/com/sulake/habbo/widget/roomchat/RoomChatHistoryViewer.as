package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_175.state = RoomChatHistoryPulldown.const_214;
         ...
         this.var_48 = param2.createWindow("chatscroller","",HabboWindowType.const_1164,HabboWindowStyle.const_42,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_175.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_214);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_175.state == RoomChatHistoryPulldown.const_369 || this.var_175.state == RoomChatHistoryPulldown.const_533;
      }
      ...
      {
         if(!this.var_419 && !this.var_1776)
         {
            this.var_419 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_175.state = RoomChatHistoryPulldown.const_369;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_48 != null)
         {
            ...
            if(param2)
            {
               this.var_48.scrollV = this.var_595;
            }
         }
         if(this.var_175 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_420 > 0 && param2)
         {
            if(this.var_1769)
            {
               if(Math.abs(param1 - this.var_420) <= const_1151)
               {
                  return;
               }
               this.var_1769 = false;
            ...
            if(this.var_419)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_48.scrollV < 1 - const_1286 / this.var_48.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1768)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_48 != null)
         {
            this.var_595 = this.var_48.scrollV;
         }
         if(this.var_48 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_595 - this.var_48.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
