package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      {
         this.var_288 = param2 as IHabboCommunicationManager;
         if(this.var_288 == null)
         {
            return;
         }
         this._connection = this.var_288.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2345 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2344 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2346 = int(this._config.getKey("interstitial.show.time","5000"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1704 > 0 && this.var_1703 >= this.var_1704)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1088;
         if(_loc1_ > this.var_2344)
         {
            ++this.var_1703;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(this.var_1357 != "")
         {
            ...
            {
               this.var_216 = new Timer(this.var_2346,1);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_456,0,0,param1.bitmapData,this.var_2343));
            this.var_1088 = getTimer();
         }
         else
         {
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1358 = _loc2_.imageUrl;
         this.var_1702 = _loc2_.clickUrl;
         if(this.var_1358 != "" && this.var_1702 != "")
         {
            _loc3_ = this.var_1358;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1358);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_423,0,0,_loc4_,this.var_1702,this.var_1087,this.var_1089));
         }
      }
