package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1977:int = 10;
      ...
      private const const_1729:uint = 4.293848814E9;
      
      private const const_1730:uint = 4.294967295E9;
      
      private const const_1976:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1567 = _loc1_.stuffTypes;
            this.var_674 = _loc1_.boxTypes;
            this.var_675 = _loc1_.ribbonTypes;
            this.var_1028 = this.var_1567[0];
            this.var_334 = this.var_674[0];
            this.var_335 = this.var_675[0];
            this.initColorGrid();
      ...
      private function method_3() : void
      {
         ...
         if(this.var_335 < 0)
         {
            this.var_335 = this.var_675.length - 1;
         }
         if(this.var_335 > this.var_675.length - 1)
         {
            this.var_335 = 0;
         }
         if(this.var_334 < 0)
         {
            this.var_334 = this.var_674.length - 1;
         }
         if(this.var_334 > this.var_674.length - 1)
         {
            this.var_334 = 0;
         }
         var _loc1_:int = this.var_674[this.var_334] * 1000 + this.var_675[this.var_335];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_93.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1028,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1567;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1028);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_674[this.var_334]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_675[this.var_335]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_93,this.var_1293,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_93.offerId,this.var_1293);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_105:
               ...
               for each(_loc7_ in this.var_214)
               {
                  ...
                  if(_loc5_.length >= this.const_1977)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2100 = _loc3_.text;
               break;
            case WindowMouseEvent.const_45:
               ...
               break;
            case WindowKeyboardEvent.const_347:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_547 == null)
         {
            this.var_547 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_547.procedure = this.suggestionsEventHandler;
         }
         if(this.var_237 == null || this.var_547 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_547.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1976;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1729) : uint(this.const_1730);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1028;
               }
            }
            _loc4_++;
         }
