package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private var var_1749:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1749 == 4294967295)
            {
               this.var_1749 = _loc1_.color;
            }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1564;
            }
         }
      }
      ...
      {
         this.var_58 = navigator.catalog.windowManager.buildFromXML(var_1388) as IItemListWindow;
         if(this.var_58 == null)
         {
