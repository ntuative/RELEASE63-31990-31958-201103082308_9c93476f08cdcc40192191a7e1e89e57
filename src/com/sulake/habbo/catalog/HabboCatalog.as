package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_286:CatalogViewer;
      
      private var var_339:ICatalogNavigator;
      ...
      private var var_287:ChargeConfirmationDialog;
      ...
      private var var_2125:GiftWrappingConfiguration;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_339.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         return this.var_306.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_306.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_85)
         {
            _loc3_ = this.var_306.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_681.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_99.getActivityPointsForType(Purse.const_178)));
         var _loc1_:int = 0;
      ...
      {
         this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_139,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_784)
         {
            if(!this.var_306.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_286.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_339 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_286 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_286.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_268,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               this.var_1595 = param1.session.isPrivateRoom;
               if(this.var_90 != null)
               {
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_339.buildCatalogIndex(_loc2_);
         if(this.var_682 && this.var_682 != "")
         {
            this.var_339.openPage(this.var_682);
            this.var_682 = "";
            this.var_846 = -1;
         }
         else if(this.var_846 > -1)
         {
            this.var_339.openPageById(this.var_846,this.var_1596);
            this.var_846 = -1;
            this.var_1596 = -1;
            this.var_682 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_286.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_286.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2126 && this.var_551 != null)
         {
            this.var_551.playSound(HabboSoundTypesEnum.const_1068);
         }
         this.var_2126 = false;
         if(this.var_287 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_66,this.var_99.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2127 && this.var_551 != null)
         {
            this.var_551.playSound(HabboSoundTypesEnum.const_1121);
         }
         this.var_2127 = false;
         if(this.var_287 != null)
         {
         ...
         if(_loc2_.type == Purse.const_178)
         {
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_286.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2125 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_287 == null)
         {
            this.var_287 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_287.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_681.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_681.add(_loc2_.productCode,_loc3_.slice());
            this.var_286.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
