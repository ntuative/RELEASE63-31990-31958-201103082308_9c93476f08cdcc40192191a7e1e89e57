package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_965:String = "bg";
      ...
      {
         this.var_17.getChildByName(const_965).style = HabboWindowStyle.const_31;
      }
      
      public function deActivate() : void
      {
         this.var_17.getChildByName(const_965).style = 3;
      }
