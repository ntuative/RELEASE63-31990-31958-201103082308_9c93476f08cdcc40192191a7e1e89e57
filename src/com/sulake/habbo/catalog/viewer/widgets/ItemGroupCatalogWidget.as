package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_614[this.var_1171][this.var_1835];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1171 = var_999.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_1171];
         var _loc3_:Array = this.var_614[this.var_1171] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1835 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1835] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_564 || _loc1_.pricingModel == Offer.const_541)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_85 || _loc3_.productType == ProductTypeEnum.const_91)
                  {
