package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1477:IScrollbarWindow;
      
      protected var var_1626:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_976 = _window.findChildByName("ctlg_product_name") as ITextWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_976.text = _loc4_;
         this.var_1219.text = _loc5_;
         this.var_976.height = this.var_976.textHeight + 5;
         this.var_1219.y = this.var_976.y + this.var_976.height;
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_455:
                  _loc6_ = this.var_1914.clone();
                  if(this.var_519 != null)
                  {
                     this.var_519.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_519,this.var_1477,this.var_1626);
                     ...
                     case ProductTypeEnum.const_252:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_278,AvatarAction.const_511);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2713)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_88 != null && true)
         {
            ...
            this.var_88.x = this.var_1913.x;
            this.var_88.y = this.var_1913.y;
            if(param3 != null)
            {
