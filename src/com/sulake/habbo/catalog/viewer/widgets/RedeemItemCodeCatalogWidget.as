package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_866:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_866.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_866 = null;
         }
         if(this.var_865 != null)
         {
            this.var_865.removeEventListener(WindowKeyboardEvent.const_197,this.windowKeyEventProcessor);
            this.var_865 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_866 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_866 != null)
         {
            this.var_866.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_865 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_865 != null)
         {
            this.var_865.addEventListener(WindowKeyboardEvent.const_197,this.windowKeyEventProcessor);
         }
         return true;
      }
