package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_565 != const_926;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1653 != RecyclerStatusMessageEvent.const_1127;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_565 == const_416;
      }
      ...
      {
         this.var_565 = const_927;
         this.var_110 = new Array(const_194);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1653)
         {
            case RecyclerStatusMessageEvent.const_1452:
               this.var_565 = const_416;
            ...
            case RecyclerStatusMessageEvent.const_1127:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1534:
               if(this.var_17 == null || this.var_17.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1226:
               if(this.var_17 != null)
               {
                  this.var_17.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1505:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_110.length < const_194)
         {
            return false;
         }
         var _loc1_:int = 0;
