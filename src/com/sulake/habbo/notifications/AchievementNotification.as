package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1710:String = "badge_bg_001_png";
      
      private const const_1996:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1729 = param6;
         this.var_78 = param10;
         this._assets = param8;
         this.var_306 = param13;
         ...
         this._window.center();
         this.var_2404 = this.var_78.getBadgeName(this.var_298);
         this.var_2405 = this.var_78.getBadgeDesc(this.var_298);
         this.var_2402 = this.var_78.getAchievementNameForFacebook(this.var_298,this.var_306.userName,this.var_306.realName,this.var_1374);
         this.var_2406 = this.var_78.getAchievementDescForFacebook(this.var_298,this.var_306.userName,this.var_306.realName,this.var_1374);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2403 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_78.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1738.toString());
         this.var_78.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1375.toString());
         this.var_78.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1375.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1729;
         var _loc17_:String = this.var_1729 == 0 ? "pixels" : "activitypoints";
         this.var_78.registerParameter(_loc16_,_loc17_,"" + this.var_2114);
         _loc15_.caption = this.var_78.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1710);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1996) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this.var_78.registerParameter(param1,"badge_name",this.var_2404);
         this.var_78.registerParameter(param1,"badge_desc",this.var_2405);
         this.var_78.registerParameter(param1,"badge_name_fb",this.var_2402);
         this.var_78.registerParameter(param1,"badge_desc_fb",this.var_2406);
         this.var_78.registerParameter(param1,"level",this.var_1374.toString());
         this.var_78.registerParameter(param1,"name",this.var_306.userName);
         return this.var_78.registerParameter(param1,"realname",this.var_306.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_306.events.removeEventListener(BadgeImageReadyEvent.const_137,this.onBadgeImageReady);
            this.var_306 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_1710);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_298,this._feedTitleFb,this.var_2403,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2407));
