package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_854:int = 70;
      
      public static const const_495:int = 4;
      
      private static const name_2:int = 0;
      
      private static const const_533:int = 1;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         this.var_1928 = this._window.height;
         this.var_791 = 4;
         this.var_792 = 0;
         this._state = name_2;
         this.var_179 = param5;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_533:
               ...
               _loc2_ = Number(this.var_1225) / Number(this.var_439["time_fade_in"]);
               if(this.var_1225 > int(this.var_439["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_982:
               ...
               if(this.var_1482 > int(this.var_439["time_display"]) && !this.var_1926)
               {
                  this.startFadeOut();
               }
               break;
            case const_983:
               ...
               _loc3_ = 1 - Number(this.var_1226) / Number(this.var_439["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1226 > int(this.var_439["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         if(this._window.height < this.var_1928)
         {
            this._window.height = this.var_1928;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_179.orientation == "TOP" ? int(const_421) : 0;
         var _loc4_:int = this.var_179.orientation == "BOTTOM" ? int(_loc2_.height - const_421) : int(_loc2_.height);
         var _loc5_:int = this.var_179.orientation == "LEFT" ? int(const_421) : 0;
         var _loc6_:int = this.var_179.orientation == "RIGHT" ? int(_loc2_.width - const_421) : int(_loc2_.width);
         if(this.var_439["position_horizontal_follow_toolbar"] == "true" && (this.var_179.orientation != "TOP" && this.var_179.orientation != "BOTTOM"))
         {
            if(this.var_179.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_495;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_495;
            }
         }
         else if(this.var_439["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_495;
         }
         else
         ...
         if(this.var_439["position_vertical_follow_toolbar"] == "true" && (this.var_179.orientation != "RIGHT" && this.var_179.orientation != "LEFT"))
         {
            if(this.var_179.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_791;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_791;
            }
         }
         else if(this.var_439["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_791;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_792;
      }
   }
}
